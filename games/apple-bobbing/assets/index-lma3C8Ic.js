...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rc(e,t,n){let r=new Float32Array(Us),i=new K(0,1,0);return new oo({name:`SphericalGaussianBlur`,defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:oc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ic(){return new oo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:oc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ac(){return new oo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oc(),fragmentShader:`
	...
	`}var sc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function Qf(){let e=new oo({vertexShader:Xf,fragmentShader:Zf,uniforms:{uMoonDir:{value:Zu}},side:1,fog:!1,depthWrite:!1});return new Z(new Xa(45,32,16),e)}var $f=`
#include <fog_pars_vertex>
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;function rp(e,t){return new oo({vertexShader:$f,fragmentShader:ep,uniforms:ro.merge([$.fog,{uTime:{value:0},uOpacity:{value:e},uColour:{value:new X(t)}}]),transparent:!0,depthWrite:!1,side:2,fog:!0})}function ip(e=!1){let t=new Cn;t.name=`ground-atmosphere`,t.userData.sceneRole=`ground-atmosphere`;let n=new qa(20,10),r=[rp(.11,2503240)];e||r.push(rp(.065,3686743)),r.forEach((e,r)=>{let i=new Z(n,e);i.name=`ground-mist-layer-${r+1}`,i.userData.sceneRole=`ground-mist-layer`,i.rotation.x=-Math.PI/2,i.rotation.z=r*.24,i.position.set(r===0?0:.7,Yu+.09+r*.09,-7),i.renderOrder=2+r,t.add(i)});let i=rp(e?.11:.145,5464696);r.push(i);let a=e?[[3.8,Yu+.38,-5.15,-.04]]:[[-4.35,Yu+.36,-5,.025],[.1,Yu+.43,-5.35,-.015],[4.15,Yu+.37,-5.1,-.035]],o=new di(new qa(5.2,.72),i,a.length);o.name=`fog-banks`,o.userData.sceneRole=`fog-banks`,o.renderOrder=4;let s=new Y,c=new K,l=new Dt,u=new K(1,1,1),d=new an;if(a.forEach(([e,t,n,r],i)=>{c.set(e,t,n),l.setFromEuler(d.set(0,0,r)),s.compose(c,l,u),o.setMatrixAt(i,s)}),o.instanceMatrix.needsUpdate=!0,o.computeBoundingBox(),o.computeBoundingSphere(),t.add(o),!e){let e=new oo({vertexShader:tp,fragmentShader:np,uniforms:ro.merge([$.fog,{uColour:{value:new X(7374250)},uOpacity:{value:.055}}]),transparent:!0,depthWrite:!1,blending:2,side:2,fog:!0}),n=new qa(2.2,5.4);for(let[r,i]of[1.3,3.15].entries()){let a=new Z(n,e);a.name=`moonlight-shaft-${r+1}`,a.userData.sceneRole=`moonlight-shaft`,a.position.set(i,1.15,-6.85-r*.4),a.rotation.set(0,-.08,-.2),t.add(a)}}function f(e,t){for(let t=0;t<r.length;t++)r[t].uniforms.uTime.value=e*(t===0?1:-.73)+t*17}return{group:t,update:f}}var ap=new K(0,1,0),op=new Di(.62,1,1,7,1,!1);function sp(e){let t=Math.sin(e*12.9898+78.233)*43758.5453;return t-Math.floor(t)}function cp(e,t,n,r,i,a,o){let s=t.clone().addScaledVector(n,r);if(e.push({start:t,end:s,radius:i}),a!==0)for(let t of[-1,1]){let c=o*2+(t>0?7:3),l=.32+sp(c)*.25,u=new K(n.x*.62+t*l,n.y*.65+.12+sp(c+1)*.08,n.z*.55+(sp(c+2)-.5)*.52).normalize();cp(e,s.clone(),u,r*(.68+sp(c+3)*.06),i*.66,a-1,c)}}function lp(e,t,n,r,i){let a=new K(t,Yu,n),o=new K(t+r,Yu+2.15,n-.08);e.push({start:a,end:o,radius:.115});let s=t<0?.42:-.42;cp(e,o.clone(),new K(s,.72,-.08).normalize(),.92,.075,4,i),cp(e,o.clone().add(new K(0,-.18,0)),new K(-s*.78,.7,.15).normalize(),.82,.07,3,i+41)}function up(e=!1){let t=new Cn;t.name=`bare-trees`,t.userData.sceneRole=`bare-trees`;let n=[];lp(n,-4.65,-5.9,.24,17),lp(n,4.55,-6.6,-.18,83);let r=new di(op,new co({color:1576981,roughness:1}),n.length);r.name=`bare-tree-branches`,r.userData.sceneRole=`bare-tree-branches`;let i=new K,a=new K,o=new Dt,s=new K,c=new Y;return n.forEach((e,t)=>{a.subVectors(e.end,e.start);let n=a.length();a.multiplyScalar(1/n),i.copy(e.start).add(e.end).multiplyScalar(.5),o.setFromUnitVectors(ap,a),s.set(e.radius,n,e.radius),c.compose(i,o,s),r.setMatrixAt(t,c)}),r.instanceMatrix.needsUpdate=!0,r.computeBoundingBox(),r.computeBoundingSphere(),t.add(r,Md([{position:[-4.48,Yu+.024,-5.68],rotation:[-Math.PI/2,0,0],scale:[.72,1.55]},{position:[4.42,Yu+.024,-6.38],rotation:[-Math.PI/2,0,0],scale:[.68,1.42]}],`tree-root-contact-occlusion`)),t}var dp=[{x:-6.2,z:-10.8,yaw:.1,width:3,height:3.25,depth:2,wall:3617065,roof:1512216,porch:!1},{x:-3.25,z:-8.8,yaw:.04,width:2.75,height:3.1,depth:1.9,wall:2700346,roof:1120029,porch:!0},{x:0,z:-10.2,yaw:-.02,width:3.2,height:3.5,depth:2.1,wall:3484728,roof:1512221,porch:!0},{x:3.45,z:-9,yaw:-.06,width:2.65,height:2.9,depth:1.9,wall:3812648,roof:1971477,porch:!0},{x:6.3,z:-11.2,yaw:-.12,width:3.1,height:3.3,depth:2,wall:2699319,roof:1185051,porch:!1}],fp=new Ti(1,1,1),pp=new Di(.045,.055,1,7),mp=new aa;mp.moveTo(-.5,0),mp.lineTo(.5,0),mp.lineTo(0,.62),mp.closePath();var hp=new Ua(mp,{depth:1,bevelEnabled:!1});hp.translate(0,0,-.5);function gp(){let e=[],t=[];function n(n,r,i,a,o,s){let c=new X(s);e.push(n,r,o,i,r,o,i,a,o,n,r,o,i,a,o,n,a,o);for(let e=0;e<6;e++)t.push(c.r,c.g,c.b)}n(-.28,-.36,.28,.36,0,1512728),n(-.22,-.3,.22,.3,.002,16756826),n(-.22,-.3,-.11,.3,.004,5579033),n(.11,-.3,.22,.3,.004,5579033),n(-.022,-.3,.022,.3,.006,2365977),n(-.22,-.018,.22,.018,.006,2365977);let r=new jr;return r.setAttribute(`position`,new yr(e,3)),r.setAttribute(`color`,new yr(t,3)),r.computeBoundingSphere(),r}var _p=gp();function vp(e,t,n,r){let i=new Cn;i.userData.sceneRole=`lit-window`,i.position.set(t,n,r);let a=new Z(_p,e);return a.userData.sceneRole=`curtain`,i.add(a),i}function yp(e,t,n,r){let i=new Cn;i.name=`neighbourhood-house-${t+1}`,i.userData.sceneRole=`house`,i.position.set(e.x,Yu,e.z),i.rotation.y=e.yaw;let a=Zd(new co({color:e.wall,emissive:e.wall,emissiveIntensity:r?.14:.075,roughness:.94}),t%2==0?`plaster`:`siding`,r),o=Zd(new co({color:e.roof,emissive:e.roof,emissiveIntensity:r?.045:.02,roughness:.98}),`shingles`,r),s=Zd(new co({color:5259835,roughness:.9}),`wood`,r),c=Zd(new co({color:2168084,roughness:.82}),`wood`,r),l=new Hr({color:16777215,vertexColors:!0}),u=new Z(fp,a);u.userData.sceneRole=`house-wall`,u.scale.set(e.width,e.height,e.depth),u.position.y=e.height/2;let d=new Z(hp,o);d.userData.sceneRole=`house-roof`,d.scale.set(e.width+.35,1.35,e.depth+.35),d.position.y=e.height;let f=new Z(fp,s);f.scale.set(e.width+.08,.18,e.depth+.08),f.position.y=.09;let p=new Z(fp,c);p.scale.set(.58,1.15,.07),p.position.set(0,.665,e.depth/2+.045),i.add(u,d,f,p);let m=[{position:[0,.024,e.depth/2+.22],rotation:[-Math.PI/2,0,0],scale:[e.width*.92,.56]}];r||(m.push({position:[0,e.height-.1,e.depth/2+.006],scale:[e.width*.9,.18]}),e.porch&&m.push({position:[0,1.28,e.depth/2+.007],scale:[1.46,.24]})),i.add(Md(m,`house-${t+1}-contact-occlusion`));let h=e.depth/2+.055,g=e.width*.27,_=e.height*.68,v=e.height*.3;if(i.add(vp(l,-g,_,h),vp(l,g,_,h),vp(l,t%2==0?-g:g,v,h)),t===1||t===3){let e=new es(16748346,2.1,4.2,2);e.name=`window-glow-${t}`,e.userData.sceneRole=`window-glow-light`,e.position.set(0,1.2,h+.48),i.add(e)}if(e.porch){let t=new Z(fp,s);t.scale.set(1.5,.09,.72),t.position.set(0,1.42,e.depth/2+.34),i.add(t);for(let t of[-.62,.62]){let n=new Z(pp,s);n.scale.y=1.28,n.position.set(t,.72,e.depth/2+.61),i.add(n)}}if(t%2==0){let t=new Z(fp,a);t.scale.set(.28,.82,.3),t.position.set(e.width*.28,e.height+.48,.15),i.add(t)}return n.push({material:l,phase:t*1.37,frequency:2.1+t*.31}),i}function bp(e=!1){let t=new Cn;t.name=`neighbourhood`,t.userData.sceneRole=`neighbourhood`;let n=[];dp.forEach((r,i)=>t.add(yp(r,i,n,e))),t.add(up(e));function r(e){for(let t of n){let n=Math.sin(e*t.frequency+t.phase),r=Math.sin(e*7.3+t.phase*2.4),i=.86+n*.08+r*.035;t.material.color.setRGB(i,i*.93,i*.82)}}return{group:t,update:r}}var xp=[{x:-2.3,z:-1.88,scale:1,yaw:.08,lit:!0},{x:2.35,z:-2.02,scale:.86,yaw:-.12,lit:!0},{x:-3.15,z:-5.55,scale:.78,yaw:.1,lit:!1},{x:3.28,z:-5.62,scale:.72,yaw:-.08,lit:!1}];function Sp(){let e=new Xa(.3,24,16),t=e.getAttribute(`position`),n=new K;for(let e=0;e<t.count;e++){n.fromBufferAttribute(t,e);let r=Math.atan2(n.z,n.x),i=1+.065*Math.cos(r*8);t.setXYZ(e,n.x*i,n.y*.8,n.z*i)}return e.computeVertexNormals(),e}function Cp(){let e=new aa;e.moveTo(-.14,.04),e.lineTo(-.045,.04),e.lineTo(-.092,.13),e.closePath();let t=new aa;t.moveTo(.045,.04),t.lineTo(.14,.04),t.lineTo(.092,.13),t.closePath();let n=new aa;return n.moveTo(-.15,-.035),n.lineTo(-.1,-.095),n.lineTo(-.05,-.04),n.lineTo(0,-.11),n.lineTo(.05,-.04),n.lineTo(.1,-.095),n.lineTo(.15,-.035),n.lineTo(.12,-.14),n.lineTo(-.12,-.14),n.closePath(),new Ja([e,t,n])}var wp=Sp(),Tp=Cp(),Ep=new Di(.035,.05,.14,7),Dp=new co({color:14179346,roughness:.7,emissive:7282952,emissiveIntensity:.32}),Op=new co({color:3883549,roughness:1}),kp=new Hr({color:16757051});function Ap(e,t){let n=new Cn;n.name=`carved-pumpkin-${t+1}`,n.userData.sceneRole=`carved-pumpkin`,n.position.set(e.x,Yu,e.z),n.rotation.y=e.yaw,n.scale.setScalar(e.scale);let r=new Z(wp,Dp);r.position.y=.24;let i=new Z(Tp,kp);i.name=`candlelit-carving`,i.position.set(0,.25,.302);let a=new Z(Ep,Op);if(a.position.y=.53,a.rotation.z=t%2==0?.11:-.08,n.add(r,i,a),!e.lit)return{group:n};let o=new es(16745512,1.35,2.7,2);return o.position.set(0,.25,.38),n.add(o),{group:n,light:o}}function jp(e=!1){let t=new Cn;t.name=`street-pumpkins`,t.userData.sceneRole=`pumpkins`;let n=[];xp.forEach((e,r)=>{let i=Ap(e,r);t.add(i.group),i.light&&n.push({light:i.light,phase:r*1.73})});let r=e?xp.filter(e=>e.lit):xp;t.add(Md(r.map(e=>({position:[e.x,Yu+.024,e.z],rotation:[-Math.PI/2,0,0],scale:[.56*e.scale,.42*e.scale]})),`pumpkin-contact-occlusion`));function i(e){for(let{light:t,phase:r}of n){let n=Math.sin(e*3.7+r),i=Math.sin(e*11.1+r*2.3);t.intensity=1.35*(.9+n*.07+i*.03)}}return{group:t,update:i}}var Mp=``+new URL(`backdrop-CDeIWZQh.jpg`,import.meta.url).href;function Np(e,t=40){let n=new Hr({fog:!1,depthWrite:!1,depthTest:!1}),r=new Z(new qa(1,1),n);r.renderOrder=-1,r.frustumCulled=!1;let i=new K;e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,t),r.quaternion.copy(e.quaternion);let a=Et.degToRad(e.fov),o=2*t*Math.tan(a/2),s={mesh:r,ready:Promise.resolve(),texture:null};return s.ready=new Promise((e,t)=>{new Io().load(Mp,t=>{t.colorSpace=``,t.minFilter=c,t.generateMipmaps=!1;let i=t.image.width/t.image.height,a=o*i;r.geometry.dispose(),r.geometry=new qa(a,o),n.map=t,n.needsUpdate=!0,s.texture=t,e()},void 0,e=>t(e instanceof Error?e:Error(String(e))))}),s}var Pp={sky:300,far:130,field:42,mid:15,near:6},Fp=[`sky`,`far`,`field`,`mid`,`near`];function Ip(e,t){return 2*t*Math.tan(e*Math.PI/360)}function Lp(e){return new Promise((t,n)=>{new Io().load(e,e=>{e.colorSpace=``,e.minFilter=c,e.generateMipmaps=!1,t(e)},void 0,e=>n(e instanceof Error?e:Error(String(e))))})}function Rp(e,t){let n=new Cn;n.name=`layeredBackdrop`;let r=new K;e.getWorldDirection(r);let i=[],a=Fp.map((a,o)=>{let s=Pp[a],c=new Hr({fog:!1,depthWrite:!1,depthTest:!1,transparent:a!==`sky`}),l=new Z(new qa(1,1),c);return l.name=`layer-${a}`,l.renderOrder=-Fp.length+o,l.frustumCulled=!1,l.position.copy(e.position).addScaledVector(r,s),l.quaternion.copy(e.quaternion),n.add(l),i.push(l),Lp(t[a]).then(t=>{let n=Ip(e.fov,s),r=t.image,i=r.width/r.height;l.geometry.dispose(),l.geometry=new qa(n*i,n),c.map=t,c.needsUpdate=!0})});return{group:n,ready:Promise.all(a).then(()=>void 0),dispose(){n.removeFromParent();for(let e of i)e.geometry.dispose(),e.material.map?.dispose(),e.material.dispose()}}}var zp={x:.05,y:.02},Bp={x:11,y:17};function Vp(e){return{x:zp.x*Math.sin(2*Math.PI*e/Bp.x),y:zp.y*Math.sin(2*Math.PI*e/Bp.y)}}var Hp=``+new URL(`sky-CdD3HFPi.webp`,import.meta.url).href,Up=``+new URL(`far-CACX_6UT.webp`,import.meta.url).href,Wp=``+new URL(`field-CChm9XGa.webp`,import.meta.url).href,Gp=``+new URL(`mid-BaCYADah.webp`,import.meta.url).href,Kp=``+new URL(`near-CigOB7p1.webp`,import.meta.url).href,qp=``+new URL(`env-BiP2YuoM.hdr`,import.meta.url).href,Jp=``+new URL(`fx-Bc8z7mrj.mp4`,import.meta.url).href,Yp=``+new URL(`fx-BmIecy6T.webm`,import.meta.url).href,Xp=class extends Fo{constructor(e){super(e),this.type=v}parse(e){let t=function(e,t){switch(e){case 1:throw Error(`THREE.HDRLoader: Read Error: `+(t||``));case 2:throw Error(`THREE.HDRLoader: Write Error: `+(t||``));case 3:throw Error(`THREE.HDRLoader: Bad File Format: `+(t||``));default:case 4:throw Error(`THREE.HDRLoader: Memory Error: `+(t||``))}},n=function(e,t,n){t||=1024;let r=e.pos,i=-1,a=0,o=``,s=String.fromCharCode.apply(null,new Uint16Array(e.subarray(r,r+128)));for(;0>(i=s.indexOf(`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=fr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=fr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=fr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=fr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let l=r(s),u=l.width,d=l.height,f=i(s.subarray(s.pos),u,d),p,m,h;switch(this.type){case _:h=f.length/4;let e=new Float32Array(h*4);for(let t=0;t<h;t++)a(f,t*4,e,t*4);p=e,m=_;break;case v:h=f.length/4;let t=new Uint16Array(h*4);for(let e=0;e<h;e++)o(f,e*4,t,e*4);p=t,m=v;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:u,height:d,data:p,header:l.string,gamma:l.gamma,exposure:l.exposure,type:m,colorSpace:Le,minFilter:c,magFilter:c,generateMipmaps:!1,flipY:!0}}setDataType(e){return this.type=e,this}};async function Zp(e,t){let n=await new Xp().loadAsync(e);n.mapping=303;let r=new Qs(t);r.compileEquirectangularShader();let i=r.fromEquirectangular(n).texture;return n.dispose(),r.dispose(),i}function Qp(e,t,n){let r=document.createElement(`video`);r.muted=!0,r.loop=!0,r.playsInline=!0,r.autoplay=!0,r.preload=`auto`,r.crossOrigin=`anonymous`,r.setAttribute(`muted`,``),r.setAttribute(`playsinline`,``),r.setAttribute(`autoplay`,``);for(let[e,n]of[[`video/webm`,t.webm],[`video/mp4`,t.mp4]]){let t=document.createElement(`source`);t.src=n,t.type=e,r.appendChild(t)}r.style.cssText=`position:fixed;width:1px;height:1px;opacity:0;pointer-events:none;`,r.setAttribute(`aria-hidden`,`true`),document.body.appendChild(r);let i=document.createElement(`canvas`);i.width=960,i.height=1080;let a=i.getContext(`2d`,{alpha:!1}),o=new xi(i);o.colorSpace=``,o.minFilter=c,o.magFilter=c,o.generateMipmaps=!1;let s=!1,l=Ip(e.fov,n),u=new K;e.getWorldDirection(u);let d=new Cn;d.name=`fxVideo`,d.visible=!1;function f(e,t){let n=new qa(e,l),r=n.attributes.uv;for(let e=0;e<r.count;e++)r.setY(e,t?.5+.5*r.getY(e):.5*r.getY(e));return r.needsUpdate=!0,n}let p={map:o,transparent:!0,depthWrite:!1,depthTest:!1,fog:!1},m={blendEquationAlpha:100,blendSrcAlpha:200,blendDstAlpha:201},h=new Hr({...p,blending:5,blendEquation:100,blendSrc:201,blendDst:201,...m}),g=new Hr({...p,blending:5,blendEquation:102,blendSrc:201,blendDst:201,...m}),_=new Z(f(16/9*l,!0),h),v=new Z(f(16/9*l,!1),g);for(let t of[_,v])t.frustumCulled=!1,t.position.copy(e.position).addScaledVector(u,n),t.quaternion.copy(e.quaternion),d.add(t);r.addEventListener(`loadedmetadata`,()=>{let e=r.videoWidth/(r.videoHeight/2);Number.isFinite(e)&&e>0&&(_.geometry.dispose(),_.geometry=f(l*e,!0),v.geometry.dispose(),v.geometry=f(l*e,!1))});async function y(){try{return await r.play(),d.visible=!0,!0}catch{return window.addEventListener(`pointerdown`,()=>{r.play().then(()=>{d.visible=!0}).catch(()=>{})},{once:!0}),!1}}function b(){if(!(!d.visible||!a||r.readyState<HTMLMediaElement.HAVE_CURRENT_DATA)){try{a.drawImage(r,0,0,i.width,i.height)}catch{d.visible=!1;return}if(!s){let e=a.getImageData(0,0,i.width,4).data,t=0;for(let n=0;n<e.length;n+=4)t+=e[n]+e[n+1]+e[n+2];if(t/(e.length/4)/3>200){console.warn(`apple-bobbing: effects video decoded blank; disabling it`),d.visible=!1;return}s=!0}o.needsUpdate=!0}}return{group:d,video:r,play:y,update:b,dispose(){r.pause(),r.removeAttribute(`src`),r.remove(),d.removeFromParent(),_.geometry.dispose(),v.geometry.dispose(),o.dispose(),h.dispose(),g.dispose()}}}var $p=.11,em=-.03,tm=.72,nm={wander:.25,damping:.8,repelDist:$p*2.4,repelStrength:.6,wallRadius:tm,wallStrength:3,maxSpeed:.12};function rm(e,t=em){return e+t}function im(e,t,n,r){return e+(t-e)*(1-Math.exp(-n*r))}function am(e,t,n,r){let i=0,a=0;for(let o of t){let t=e.x-o.x,s=e.z-o.z,c=Math.hypot(t,s);if(c===0||c>=n)continue;let l=r*(1-c/n);i+=t/c*l,a+=s/c*l}return{x:i,z:a}}function om(e,t,n){let r=Math.hypot(e.x,e.z);if(r<=t||r===0)return{x:0,z:0};let i=n*(r-t);return{x:-e.x/r*i,z:-e.z/r*i}}function sm(e,t,n,r,i=nm){let a=(r()*2-1)*i.wander,o=(r()*2-1)*i.wander,s=am(e,t,i.repelDist,i.repelStrength),c=om(e,i.wallRadius,i.wallStrength);a+=s.x+c.x,o+=s.z+c.z;let l=Math.exp(-i.damping*n),u=(e.vx+a*n)*l,d=(e.vz+o*n)*l,f=Math.hypot(u,d);return f>i.maxSpeed&&(u*=i.maxSpeed/f,d*=i.maxSpeed/f),{...e,x:e.x+u*n,z:e.z+d*n,vx:u,vz:d}}function cm(e,t,n=.9){let r=Math.sqrt(Math.max(0,1-e*e-t*t));return{rx:Math.atan2(t,r)*n+0,rz:-Math.atan2(e,r)*n+0}}function lm(e,t,n=tm,r=$p*2.2,i=50){let a={x:0,z:0},o=-1/0;for(let s=0;s<i;s++){let i=Math.sqrt(t())*n,s=t()*Math.PI*2,c={x:Math.cos(s)*i,z:Math.sin(s)*i},l=1/0;for(let t of e)l=Math.min(l,Math.hypot(c.x-t.x,c.z-t.z));if(l>=r)return c;l>o&&(o=l,a=c)}return a}var um=[12986408,13840175,12000284,15022389,10275941,12986408,14172949];function dm(e){let t=new Cn,n=new Z(new Xa($p,32,24),new co({color:e,roughness:.35,metalness:0,emissive:e,emissiveIntensity:.12}));n.scale.set(1,.88,1);let r=new Z(new Di(.008,.012,.06,8),new co({color:5125166,roughness:.9}));r.position.set(0,$p*.88+.02,0),r.rotation.z=.25;let i=new Z(new Xa(.03,12,8),new co({color:4431943,roughness:.7}));return i.scale.set(1,.25,.5),i.position.set(.035,$p*.88+.03,0),t.add(n,r,i),t}var fm=class{id;group;state;caught=!1;constructor(e,t,n){this.id=e,this.group=dm(n),this.group.rotation.order=`ZXY`,this.group.userData.appleId=e,this.state={x:t.x,z:t.z,vx:0,vz:0,y:em,spin:Math.random()*Math.PI*2},this.group.position.set(t.x,this.state.y,t.z)}moveTo(e){this.state={...this.state,x:e.x,z:e.z,vx:0,vz:0,y:em},this.group.position.set(e.x,this.state.y,e.z)}};function pm(e,t){let n=[];for(let r=0;r<e;r++){let e=lm(n.map(e=>e.state),t);n.push(new fm(r,e,um[r%um.length]))}return n}function mm(e,t){let n=t;for(;n;){let t=n.userData.appleId;if(typeof t==`number`)return e[t]??null;n=n.parent}return null}function hm(e,t,n,r){let i=e.filter(e=>!e.caught);for(let e of i){let a=i.filter(t=>t!==e).map(e=>e.state),o=sm(e.state,a,n,r),s=t(o.x,o.z);o={...o,y:im(o.y,rm(s.height),10,n),spin:o.spin+.25*n},e.state=o;let c=cm(s.nx,s.nz);e.group.position.set(o.x,o.y,o.z),e.group.rotation.set(c.rx,o.spin,c.rz)}}var gm=class{scene=new Mn;camera=new ts(-1,1,1,-1,0,1);mesh;constructor(e){this.mesh=new Z(new qa(2,2),e),this.mesh.frustumCulled=!1,this.scene.add(this.mesh)}render(e,t){e.setRenderTarget(t),e.render(this.scene,this.camera)}},_m=`const float IOR_AIR = 1.0;
...
`,ym=vm;function bm(e,t){return`${vm}${t===`fragment`?`#define BUCKET_FRAGMENT
`:``}${_m}\n${e}`}var xm=`in vec3 position;
out vec2 coord;
...
`,Sm=`const float PI = 3.141592653589793;
...
`;function Tm(e){return new Kt(256,256,{type:e,format:E,minFilter:c,magFilter:c,wrapS:r,wrapT:r,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1})}function Em(e,t){return new so({glslVersion:He,vertexShader:ym+xm,fragmentShader:ym+e,uniforms:t,depthTest:!1,depthWrite:!1})}var Dm=class{a;b;current;dropMat;updateMat;normalsMat;pass;queue=[];constructor(e){let t=e?_:v;this.a=Tm(t),this.b=Tm(t),this.current=this.a;let n=new G(1/256,1/256);this.dropMat=Em(Sm,{uWater:{value:null},uCenter:{value:new G},uRadius:{value:.03},uStrength:{value:.04}}),this.updateMat=Em(Cm,{uWater:{value:null},uDelta:{value:n}}),this.normalsMat=Em(wm,{uWater:{value:null},uDelta:{value:n}}),this.pass=new gm(this.updateMat)}get texture(){return this.current.texture}addDrop(e,t,n=.03,r=.04){this.queue.push({x:e,z:t,radius:n,strength:r})}step(e){for(let t of this.queue)this.dropMat.uniforms.uCenter.value.set(t.x,t.z),this.dropMat.uniforms.uRadius.value=t.radius,this.dropMat.uniforms.uStrength.value=t.strength,this.swapRender(e,this.dropMat);this.queue=[],this.swapRender(e,this.updateMat),this.swapRender(e,this.normalsMat)}swapRender(e,t){t.uniforms.uWater.value=this.current.texture;let n=this.current===this.a?this.b:this.a;this.pass.mesh.material=t,this.pass.render(e,n),this.current=n}},Om=`in vec3 position;
out vec3 oldPos;
out vec3 newPos;
...
`;function Pm(){return new qa(2,2,200,200)}var Fm=class{mesh;material;constructor(e=Pm(),t){this.material=new so({glslVersion:He,vertexShader:ym+Mm,fragmentShader:bm(Nm,`fragment`),uniforms:{uLight:{value:Xu},uWater:{value:null},uCaustics:{value:null},uIron:{value:t},uMoonDir:{value:Zu}},side:2}),this.mesh=new Z(e,this.material),this.mesh.frustumCulled=!1}setTextures(e,t){this.material.uniforms.uWater.value=e,this.material.uniforms.uCaustics.value=t}},Im=`
uniform mat4 projectionMatrix;
uniform mat4 modelViewMatrix;
uniform mat4 modelMatrix;
in vec3 position;
...
`,Rm=class{group=new Cn;wallMaterial;floorMaterial;constructor(e){let t={uLight:{value:Xu},uWater:{value:null},uCaustics:{value:null},uIron:{value:e}},n=e=>new so({glslVersion:He,vertexShader:ym+Im,fragmentShader:bm(Lm,`fragment`),uniforms:t,side:e});this.wallMaterial=n(1),this.floorMaterial=n(0);let r=new Z(new Di(1,1,qu+Ju,96,1,!0),this.wallMaterial);r.position.y=(Ju-qu)/2;let i=new Z(new Ei(1,96),this.floorMaterial);i.rotation.x=-Math.PI/2,i.position.y=-qu,this.group.add(r,i)}setTextures(e,t){this.wallMaterial.uniforms.uWater.value=e,this.wallMaterial.uniforms.uCaustics.value=t}},zm=`
uniform sampler2D uWater;
in vec2 coord;
out vec4 fragColor;
...
`;function Bm(e,t){let n=t*4;return{height:(e[n]/255-.5)/2,nx:e[n+1]/255*2-1,nz:e[n+2]/255*2-1}}function Vm(e,t,n){return e+(t-e)*n}function Hm(e,t,n){return{height:Vm(e.height,t.height,n),nx:Vm(e.nx,t.nx,n),nz:Vm(e.nz,t.nz,n)}}function Um(e,t,n,r){let i=n*.5+.5,a=r*.5+.5,o=Math.min(Math.max(i*t-.5,0),t-1),s=Math.min(Math.max(a*t-.5,0),t-1),c=Math.floor(o),l=Math.floor(s),u=Math.min(c+1,t-1),d=Math.min(l+1,t-1),f=o-c,p=s-l;return Hm(Hm(Bm(e,l*t+c),Bm(e,l*t+u),f),Hm(Bm(e,d*t+c),Bm(e,d*t+u),f),p)}function Wm(e){let t=new Uint8Array(e*e*4);for(let n=0;n<e*e;n++)t[n*4]=128,t[n*4+1]=128,t[n*4+2]=128,t[n*4+3]=255;return t}var Gm=class{target=new Kt(32,32,{type:d,format:E,minFilter:a,magFilter:a,depthBuffer:!1,stencilBuffer:!1});material=new so({glslVersion:He,vertexShader:ym+xm,fragmentShader:ym+zm,uniforms:{uWater:{value:null}},depthTest:!1,depthWrite:!1});pass=new gm(this.material);buffer=new Uint8Array(4096);latest=Wm(32);pending=!1;update(e,t){this.material.uniforms.uWater.value=t,this.pass.render(e,this.target),!this.pending&&(this.pending=!0,e.readRenderTargetPixelsAsync(this.target,0,0,32,32,this.buffer).then(()=>{this.latest.set(this.buffer)}).catch(e=>{console.warn(`Height readback failed`,e)}).finally(()=>{this.pending=!1}))}sample=(e,t)=>Um(this.latest,32,e,t)},Km=`
...
`,qm=class{material=new so({glslVersion:He,vertexShader:ym+xm,fragmentShader:ym+Km,uniforms:{uTex:{value:null}},depthTest:!1,depthWrite:!1});pass=new gm(this.material);viewport=new Wt;draw(e,t,n=256){e.getViewport(this.viewport),this.material.uniforms.uTex.value=t,e.setRenderTarget(null),e.setScissorTest(!0),e.setScissor(0,0,n,n),e.setViewport(0,0,n,n),e.render(this.pass.scene,this.pass.camera),e.setScissorTest(!1),e.setViewport(this.viewport)}},Jm=new hi(new K(0,1,0),0);function Ym(e,t){let n=e.getBoundingClientRect();return new G((t.clientX-n.left)/n.width*2-1,-((t.clientY-n.top)/n.height)*2+1)}function Xm(e,t){let n=null,r=r=>{if(r.pointerType===`mouse`&&r.button!==0)return;let i=Ym(e,r);if(t.onDown(i)&&n===null){try{e.setPointerCapture(r.pointerId)}catch{n=null;return}n=r.pointerId}},i=r=>{r.pointerId===n&&t.onDrag(Ym(e,r))},a=r=>{r.pointerId===n&&(e.hasPointerCapture(r.pointerId)&&e.releasePointerCapture(r.pointerId),n=null,t.onUp())},o=e=>{e.pointerId===n&&(n=null,t.onUp())};return e.addEventListener(`pointerdown`,r),e.addEventListener(`pointermove`,i),e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a),e.addEventListener(`lostpointercapture`,o),()=>{e.removeEventListener(`pointerdown`,r),e.removeEventListener(`pointermove`,i),e.removeEventListener(`pointerup`,a),e.removeEventListener(`pointercancel`,a),e.removeEventListener(`lostpointercapture`,o)}}function Zm(e){let t=e.ray.intersectPlane(Jm,new K);return!t||Math.hypot(t.x,t.z)>1?null:t}function Qm(e,t){let n=e.slice();for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}var $m=class{facts;rng;pile=[];constructor(e,t=Math.random){if(this.facts=e,this.rng=t,e.length===0)throw Error(`FactDeck needs at least one fact`)}draw(){return this.pile.length===0&&(this.pile=Qm(this.facts,this.rng)),this.pile.pop()}putBack(e){let t=Math.floor(this.rng()*(this.pile.length+1));this.pile.splice(t,0,e)}get size(){return this.facts.length}remaining(){return this.pile.length}},eh=[{id:`flash-01`,category:`FlashSystem`,title:`One family, one software stack`,body:`PLACEHOLDER: Every IBM FlashSystem model runs the same Storage Virtualize software, so skills and automation carry across the whole range.`},{id:`flash-02`,category:`FlashSystem`,title:`FlashCore Modules compress inline`,body:`PLACEHOLDER: FlashCore Modules compress and encrypt data in hardware, so capacity savings don't cost host performance.`},{id:`flash-03`,category:`FlashSystem`,title:`Ransomware detection on the array`,body:`PLACEHOLDER: FlashSystem can spot ransomware-style write patterns in under a minute using inline data statistics.`},{id:`scale-01`,category:`Storage Scale`,title:`Global data platform`,body:`PLACEHOLDER: IBM Storage Scale presents file, object and HDFS access to the same data, on premises or in the cloud.`},{id:`scale-02`,category:`Storage Scale`,title:`Built for AI pipelines`,body:`PLACEHOLDER: Storage Scale System 6000 is designed to feed GPUs with hundreds of gigabytes per second per node.`},{id:`defender-01`,category:`Storage Defender`,title:`Copies you can trust`,body:`PLACEHOLDER: IBM Storage Defender validates backup copies and safeguarded snapshots so you know which point in time is clean.`},{id:`defender-02`,category:`Storage Defender`,title:`Safeguarded Copy`,body:`PLACEHOLDER: Safeguarded Copy takes immutable, logically air-gapped snapshots that admins cannot delete before their expiry.`},{id:`ceph-01`,category:`Ceph`,title:`Software-defined and open`,body:`PLACEHOLDER: IBM Storage Ceph provides block, file and S3 object storage on commodity servers with an open-source core.`},{id:`ceph-02`,category:`Ceph`,title:`Scale out, not up`,body:`PLACEHOLDER: Add nodes to grow Ceph capacity and performance together, with data rebalanced automatically.`},{id:`tape-01`,category:`Tape`,title:`Tape is still the cheapest bit`,body:`PLACEHOLDER: LTO tape stores cold data at a fraction of the cost per terabyte of disk, with a 30-year archival life.`},{id:`tape-02`,category:`Tape`,title:`Physical air gap`,body:`PLACEHOLDER: A tape cartridge on a shelf cannot be reached by an attacker on the network. That's the original air gap.`},{id:`tip-01`,category:`Tip`,title:`Try tapping the water`,body:`PLACEHOLDER: Tap the open water to make a splash and watch the apples bob.`}],th=[`FlashSystem`,`Storage Scale`,`Storage Defender`,`Ceph`,`Tape`,`Tip`],nh=[{id:`fallback-01`,category:`Tip`,title:`Facts are loading`,body:`The fact list could not be read, but the apples still float. Try another one!`}];function rh(e){if(typeof e!=`object`||!e)return!1;let t=e;return[`id`,`title`,`body`,`category`].every(e=>typeof t[e]==`string`&&t[e].length>0)}function ih(e){return Array.isArray(e)?e.filter(rh):[]}function ah(){let e=ih(eh);return e.length>0?e:nh}var oh=[{id:`q-flash-01`,factId:`flash-01`,prompt:`PLACEHOLDER: Which software runs on every IBM FlashSystem model?`,answers:[`Storage Virtualize`,`Storage Scale`,`Storage Defender`,`Storage Ceph`],correct:0},{id:`q-flash-02`,factId:`flash-02`,prompt:`PLACEHOLDER: Where do FlashCore Modules compress and encrypt data?`,answers:[`In the host operating system`,`In hardware on the module`,`In a backup appliance`,`In the cloud`],correct:1},{id:`q-flash-03`,factId:`flash-03`,prompt:`PLACEHOLDER: Roughly how fast can FlashSystem flag ransomware-style write patterns?`,answers:[`Within a day`,`Within an hour`,`Under a minute`,`Only after a restore`],correct:2},{id:`q-scale-01`,factId:`scale-01`,prompt:`PLACEHOLDER: IBM Storage Scale presents the same data through which access methods?`,answers:[`File only`,`Block and tape`,`File, object and HDFS`,`Email and FTP`],correct:2},{id:`q-scale-02`,factId:`scale-02`,prompt:`PLACEHOLDER: What is Storage Scale System 6000 designed to keep fed?`,answers:[`GPUs`,`Printers`,`Mainframe tape drives`,`Web caches`],correct:0},{id:`q-defender-01`,factId:`defender-01`,prompt:`PLACEHOLDER: What does IBM Storage Defender check about your backup copies?`,answers:[`That they are the largest`,`That they are the oldest`,`That they are clean and trustworthy`,`That they are stored on tape`],correct:2},{id:`q-defender-02`,factId:`defender-02`,prompt:`PLACEHOLDER: What can an admin NOT do to a Safeguarded Copy before it expires?`,answers:[`Read it`,`Delete it`,`Restore from it`,`Report on it`],correct:1},{id:`q-ceph-01`,factId:`ceph-01`,prompt:`PLACEHOLDER: IBM Storage Ceph runs on what kind of hardware?`,answers:[`Proprietary appliances only`,`Commodity servers`,`Mainframes only`,`Tape libraries`],correct:1},{id:`q-ceph-02`,factId:`ceph-02`,prompt:`PLACEHOLDER: How do you grow capacity and performance in a Ceph cluster?`,answers:[`Buy a bigger controller`,`Add nodes`,`Add more tape`,`Reformat the volumes`],correct:1},{id:`q-tape-01`,factId:`tape-01`,prompt:`PLACEHOLDER: What archival life is quoted for LTO tape?`,answers:[`3 years`,`10 years`,`30 years`,`100 years`],correct:2},{id:`q-tape-02`,factId:`tape-02`,prompt:`PLACEHOLDER: Why can't a network attacker reach a tape cartridge on a shelf?`,answers:[`It is encrypted`,`It is physically air-gapped`,`It is compressed`,`It is read-only`],correct:1},{id:`q-tip-01`,factId:`tip-01`,prompt:`PLACEHOLDER: What happens when you tap the open water?`,answers:[`An apple sinks`,`The lights go out`,`You make a splash`,`The cauldron empties`],correct:2}];function sh(e){return typeof e==`string`&&e.length>0}function ch(e){if(typeof e!=`object`||!e)return!1;let t=e;if(![`id`,`factId`,`prompt`].every(e=>sh(t[e])))return!1;let n=t.answers;if(!Array.isArray(n)||n.length!==4||!n.every(sh))return!1;let r=t.correct;return Number.isInteger(r)&&r>=0&&r<4}function lh(e){return Array.isArray(e)?e.filter(ch):[]}function uh(){return lh(oh)}function dh(e){let t=th.filter(t=>t!==e.category).slice(0,3);return{id:`fallback-${e.id}`,factId:e.id,prompt:`Which IBM Storage product is this fact about?`,answers:[e.category,...t],correct:0}}function fh(e,t){return e.find(e=>e.factId===t.id)??dh(t)}function ph(e,t){let n=Qm(e.answers.map((e,t)=>t),t);return{answers:n.map(t=>e.answers[t]),correct:n.indexOf(e.correct)}}function mh(e){return{total:e,remaining:e}}function hh(e,t){if(e.remaining<=0)return{state:e,expired:!1};let n=Math.max(0,e.remaining-t);return{state:{total:e.total,remaining:n},expired:n===0}}function gh(e){return e.total>0?e.remaining/e.total:0}var _h=.25,vh=.4,yh=.35;function bh(){return{phase:`idle`,appleId:null,elapsed:0}}function xh(e,t){return e.phase===`idle`?{phase:`dunking`,appleId:t,elapsed:0}:e}function Sh(e,t){return e.phase===`quizzing`?{phase:t?`lifting`:`releasing`,appleId:e.appleId,elapsed:0}:e}function Ch(e){return e.phase===`showing`?{phase:`respawning`,appleId:e.appleId,elapsed:0}:e}function wh(e){return e.phase===`dunking`?Math.min(1,e.elapsed/_h):0}function Th(e){return e.phase===`lifting`?Math.min(1,e.elapsed/vh):0}function Eh(e){return e.phase===`releasing`?Math.min(1,e.elapsed/yh):0}function Dh(e,t){let n=[];if(e.phase===`idle`||e.phase===`showing`||e.phase===`quizzing`)return{state:e,events:n};let r=e.elapsed+t;return e.phase===`dunking`?r<.25?{state:{...e,elapsed:r},events:n}:(n.push({type:`quizStart`,appleId:e.appleId}),{state:{phase:`quizzing`,appleId:e.appleId,elapsed:0},events:n}):e.phase===`lifting`?(e.elapsed===0&&n.push({type:`liftStart`,appleId:e.appleId}),r<.4?{state:{...e,elapsed:r},events:n}:(n.push({type:`showFact`,appleId:e.appleId}),{state:{phase:`showing`,appleId:e.appleId,elapsed:0},events:n})):e.phase===`releasing`?r<.35?{state:{...e,elapsed:r},events:n}:(n.push({type:`released`,appleId:e.appleId}),{state:bh(),events:n}):r<.3?{state:{...e,elapsed:r},events:n}:(n.push({type:`respawned`,appleId:e.appleId}),{state:bh(),events:n})}var Oh=class{minDist;constructor(e=.03){this.minDist=e}last=null;next(e,t){return this.last&&Math.hypot(e-this.last.x,t-this.last.z)<this.minDist?!1:(this.last={x:e,z:t},!0)}reset(){this.last=null}};function kh(e){let t=document.getElementById(e);if(!t)throw Error(`Missing #${e}`);return t}var Ah=class{onDismiss;card=kh(`fact-card`);backdrop=kh(`backdrop`);category=kh(`fact-category`);progress=kh(`fact-progress`);title=kh(`fact-title`);body=kh(`fact-body`);button=kh(`fact-dismiss`);open=!1;constructor(e){this.onDismiss=e,this.button.addEventListener(`click`,()=>this.hide()),this.backdrop.addEventListener(`pointerdown`,()=>this.hide())}get isOpen(){return this.open}show(e,t,n){this.category.textContent=e.category,this.progress.textContent=`Fact ${t} of ${n}`,this.title.textContent=e.title,this.body.textContent=e.body,this.card.classList.remove(`hidden`),this.backdrop.classList.remove(`hidden`),this.open=!0,this.button.focus()}hide(){this.open&&(this.card.classList.add(`hidden`),this.backdrop.classList.add(`hidden`),this.open=!1,this.onDismiss())}},jh=1100,Mh=3,Nh=class{card=kh(`quiz-card`);backdrop=kh(`backdrop`);bar=kh(`quiz-bar`);seconds=kh(`quiz-seconds`);category=kh(`quiz-category`);prompt=kh(`quiz-prompt`);buttons=Array.from(kh(`quiz-answers`).querySelectorAll(`button.answer`));open=!1;locked=!1;onAnswer=null;constructor(){this.buttons.forEach((e,t)=>{e.addEventListener(`click`,()=>{this.open&&!this.locked&&this.onAnswer?.(t)})})}get isOpen(){return this.open}show(e){this.category.textContent=e.category,this.prompt.textContent=e.prompt,this.buttons.forEach((t,n)=>{t.textContent=e.answers[n]??``,t.disabled=!1,t.classList.remove(`right`,`wrong`)}),this.bar.classList.remove(`urgent`),this.onAnswer=e.onAnswer,this.locked=!1,this.card.classList.remove(`hidden`),this.backdrop.classList.remove(`hidden`),this.open=!0,this.buttons[0]?.focus()}setCountdown(e,t){this.bar.style.width=`${Math.max(0,Math.min(1,e))*100}%`,this.bar.classList.toggle(`urgent`,t<=Mh),this.seconds.textContent=String(Math.ceil(t))}resolve(e,t){this.locked=!0;for(let e of this.buttons)e.disabled=!0;let n=e===t;return!n&&e!==null&&this.buttons[e]?.classList.add(`wrong`),this.buttons[t]?.classList.add(`right`),new Promise(e=>window.setTimeout(e,n?500:jh))}hide(){this.open&&(this.card.classList.add(`hidden`),this.backdrop.classList.add(`hidden`),this.open=!1,this.onAnswer=null)}},Ph=class{counter=kh(`counter`);count=kh(`caught-count`);factsLeft=kh(`facts-left`);attract=kh(`attract`);fps=kh(`fps`);caught=0;fpsEnabled=!1;fpsAccum=0;fpsFrames=0;constructor(){this.counter.addEventListener(`animationend`,()=>this.counter.classList.remove(`pop`))}increment(){this.caught+=1,this.count.textContent=String(this.caught),this.counter.classList.remove(`pop`),this.counter.offsetWidth,this.counter.classList.add(`pop`)}setFactsLeft(e){this.factsLeft.textContent=String(e)}showHint(){this.attract.classList.remove(`hidden`)}hideHint(){this.attract.classList.add(`hidden`)}enableFps(){this.fpsEnabled=!0,this.fps.classList.remove(`hidden`)}updateFps(e){this.fpsEnabled&&(this.fpsAccum+=e,this.fpsFrames+=1,this.fpsAccum>=.5&&(this.fps.textContent=`${Math.round(this.fpsFrames/this.fpsAccum)} fps`,this.fpsAccum=0,this.fpsFrames=0))}},Fh=class{threshold;elapsed=0;idle=!1;constructor(e=60){this.threshold=e}get isIdle(){return this.idle}touch(){this.elapsed=0,this.idle=!1}update(e){return!this.idle&&(this.elapsed+=e,this.elapsed>=this.threshold&&(this.idle=!0,!0))}},Ih=7,Lh=.16,Rh=60,zh=2.5,Bh=14,Vh=new URLSearchParams(location.search),Hh=Vh.has(`orbit`),Uh=Vh.has(`drift`),Wh=Vh.has(`debug`),Gh=Vh.get(`quality`)===`low`,Kh=Vh.get(`scene`)===`procedural`?`procedural`:Vh.get(`scene`)===`plate`?`plate`:`layered`,qh=Kh!==`procedural`,Jh=Kh===`layered`;function Yh(e){let t=kh(`error`);t.textContent=e,t.classList.remove(`hidden`)}function Xh(){let e=Ku();if(!e.ok){Yh(e.reason??`Unsupported display.`);return}J.enabled=!1;let t=new Gu({antialias:!0});t.outputColorSpace=Le,t.setPixelRatio(Math.min(window.devicePixelRatio,Gh?1:2)),t.setSize(window.innerWidth,window.innerHeight),kh(`app`).appendChild(t.domElement),console.info(`apple-bobbing: floatLinear=${e.floatLinear} quality=${Gh?`low`:`high`}`);let n=new Mn;n.background=Jh?null:new X(131849);let r=wd(window.innerWidth/window.innerHeight),i=Hh?Td(r,t.domElement):null;qh&&(Xu.set(.5,.35,.79).normalize(),Zu.copy(Xu));let a=Yf(),o=Mf(a);n.add(...Ed(),o);let s=Dd();qh&&n.add(s);let c=null,l=null,u=null;function d(){n.fog=new jn(922141,.045),c=bp(Gh),l=jp(Gh);let e=Cf(Gh),t=gf(Gh);u=ip(Gh);let r=Od(Gh);n.add(r,r.target,Qf(),_f(),e,t,c.group,l.group,u.group)}let f=!1,p=null,m=null;function h(){let e=Np(r);n.add(e.mesh),e.ready.then(()=>{if(!e.texture)return;let t=e.texture.clone();t.mapping=303,t.needsUpdate=!0,Pf(o,t,.55)}).catch(()=>{}),e.ready.catch(t=>{console.warn(`Backdrop plate failed to load; falling back to the procedural background.`,t),n.remove(e.mesh),d()})}if(Jh){Zp(qp,t).then(e=>{n.environment=e,n.environmentIntensity=Bh,Pf(o,e,Bh),s.intensity*=.5}).catch(e=>console.warn(`Environment probe failed to load; keeping the matched lights.`,e)),n.add(Nf());let e=Rp(r,{sky:Hp,far:Up,field:Wp,mid:Gp,near:Kp});p=new Mn,p.add(e.group),e.ready.then(()=>{if(f=Uh&&!Hh&&!Gh,!Gh&&p){let t=Qp(r,{mp4:Jp,webm:Yp},Pp.field),n=e.group.getObjectByName(`layer-field`).renderOrder+.5;t.group.children.forEach((e,t)=>{e.renderOrder=n+t*.1}),p.add(t.group),m=t.update,t.play().then(e=>{e||console.info(`apple-bobbing: effects video waits for the first tap (autoplay blocked)`)})}}).catch(t=>{console.warn(`Layered backdrop failed to load; falling back to the single plate.`,t),e.dispose(),p=null,h()})}else qh?(n.add(Nf()),h()):d();let g=Pm(),_=new Dm(e.floatLinear),v=Gh?null:new jm(g,a.map),y=v?v.texture:jm.neutralTexture(),b=new Fm(g,a.map),x=new Rm(a.map);n.add(b.mesh,x.group);let S=new Gm,C=pm(Ih,Math.random);for(let e of C)n.add(e.group);let w=new $m(ah()),T=new Ph,E=w.size;T.setFactsLeft(E),Wh&&T.enableFps();let D=bh(),O=new K,k=new Fh(Rh),A=0,j=0,ee=new Ah(()=>{k.touch(),T.hideHint(),D=Ch(D)}),M=uh(),N=new Nh,P=null,F=null,te=()=>ee.isOpen||N.isOpen;function ne(){let e=w.draw();T.setFactsLeft(w.remaining());let t=fh(M,e),n=ph(t,Math.random);F={fact:e,correct:n.correct},P=mh(12),N.setCountdown(1,12),N.show({category:e.category,prompt:t.prompt,answers:n.answers,onAnswer:re})}function re(e){if(!F||D.phase!==`quizzing`||P===null)return;let{fact:t,correct:n}=F,r=e===n;P=null,k.touch(),N.resolve(e,n).then(()=>{N.hide(),r||(F=null,w.putBack(t),T.setFactsLeft(w.remaining())),D=Sh(D,r)})}let ie=Wh?new qm:null,ae=new Cs,oe=new Oh;Xm(t.domElement,{onDown:e=>{if(k.touch(),T.hideHint(),te())return!1;ae.setFromCamera(e,r);let t=C.filter(e=>!e.caught).map(e=>e.group),n=ae.intersectObjects(t,!0),i=n.length>0?mm(C,n[0].object):null;if(i&&D.phase===`idle`)return D=xh(D,i.id),i.caught=!0,O.copy(i.group.position),_.addDrop(i.state.x,i.state.z,.1,.1),!1;let a=Zm(ae);return a?(_.addDrop(a.x,a.z,.07,.14),oe.reset(),oe.next(a.x,a.z),!0):!1},onDrag:e=>{k.touch(),ae.setFromCamera(e,r);let t=Zm(ae);t&&oe.next(t.x,t.z)&&_.addDrop(t.x,t.z,.045,.04)},onUp:()=>{oe.reset()}});for(let e=0;e<12;e++)_.addDrop(Math.random()*1.6-.8,Math.random()*1.6-.8,.05,e%2?.04:-.04);window.addEventListener(`resize`,()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)});let se=new cs,I=!0,L=0;function ce(e){I=!1,Yh(e)}t.debug.onShaderError=(e,t,n,r)=>{console.error(`Shader link failed`,e.getProgramInfoLog(t),`
vertex:`,e.getShaderInfoLog(n),`
fragment:`,e.getShaderInfoLog(r)),ce(`Rendering failed to start on this display.`)},t.domElement.addEventListener(`webglcontextlost`,()=>{ce(`The display lost its graphics context. Restarting…`),window.setTimeout(()=>location.reload(),3e3)});function le(){if(!I)return;requestAnimationFrame(le),se.update();let e=se.getDelta(),a=Math.min(e,.05);L+=a,_.step(t),v?.update(t,_.texture),S.update(t,_.texture),b.setTextures(_.texture,y),x.setTextures(_.texture,y),c?.update(L),l?.update(L),u?.update(L,a),hm(C,S.sample,a,Math.random);let o=Dh(D,a);if(D=o.state,D.phase===`quizzing`&&P!==null){let e=hh(P,a);P=e.state,N.setCountdown(gh(P),P.remaining),e.expired&&re(null)}let s=D.phase===`dunking`||D.phase===`quizzing`||D.phase===`lifting`||D.phase===`releasing`;if(D.appleId!==null&&s){let e=C[D.appleId];if(D.phase===`dunking`||D.phase===`quizzing`){let t=D.phase===`quizzing`?1:wh(D),n=1-(1-t)*(1-t);e.group.position.set(O.x,O.y-Lh*n,O.z),e.group.scale.set(1+.1*n,1-.15*n,1+.1*n)}else if(D.phase===`releasing`){let t=Eh(D),n=1-(1-(1-t)*(1-t));e.group.position.set(O.x,O.y-Lh*n,O.z),e.group.scale.set(1+.1*n,1-.15*n,1+.1*n)}else{let t=Th(D),n=1-(1-t)**3,r=O.y-Lh+.86*n;e.group.position.set(O.x,r,O.z),e.group.rotation.set(0,e.state.spin+t*2,0),e.group.scale.setScalar(1+.3*t)}}for(let e of o.events){let t=C[e.appleId];if(e.type===`quizStart`)ne();else if(e.type===`liftStart`)_.addDrop(t.state.x,t.state.z,.09,-.12);else if(e.type===`showFact`)t.group.visible=!1,T.increment(),F&&ee.show(F.fact,E-w.remaining(),E),F=null;else if(e.type===`released`)t.group.position.copy(O),t.group.scale.setScalar(1),t.caught=!1,_.addDrop(t.state.x,t.state.z,.08,.1);else{let e=lm(C.filter(e=>e!==t).map(e=>e.state),Math.random);t.moveTo(e),t.group.scale.setScalar(1),t.group.visible=!0,t.caught=!1,_.addDrop(e.x,e.z,.07,.1)}}if(!te()&&k.update(e)&&(T.showHint(),A=Math.floor(Math.random()*C.length),j=zh),k.isIdle&&!te()&&(j+=a,j>=zh)){j=0;let e=C.filter(e=>!e.caught);if(e.length>0){let t=e[A%e.length];_.addDrop(t.state.x,t.state.z,.09,.08)}}if(f){let e=Vp(L);r.position.set(Sd.x+e.x,Sd.y+e.y,Sd.z),r.lookAt(xd)}i?.update(),t.setRenderTarget(null),p?(m?.(),t.render(p,r),t.autoClear=!1,t.render(n,r),t.autoClear=!0):t.render(n,r),ie?.draw(t,_.texture),T.updateFps(e)}le()}Xh();