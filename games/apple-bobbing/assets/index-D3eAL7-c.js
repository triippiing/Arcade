...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Js(e,t,n){let r=new Float32Array(Ps),i=new G(0,1,0);return new to({name:`SphericalGaussianBlur`,defines:{n:Ps,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Zs(),fragmentShader:`
	...
	`}var Qs=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function Vf(){let e=new to({vertexShader:zf,fragmentShader:Bf,uniforms:{uMoonDir:{value:Hu}},side:1,fog:!1,depthWrite:!1});return new Z(new Ga(45,32,16),e)}var Hf=`
#include <fog_pars_vertex>
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;function Kf(e,t){return new to({vertexShader:Hf,fragmentShader:Uf,uniforms:Qa.merge([$.fog,{uTime:{value:0},uOpacity:{value:e},uColour:{value:new Y(t)}}]),transparent:!0,depthWrite:!1,side:2,fog:!0})}function qf(e=!1){let t=new wn;t.name=`ground-atmosphere`,t.userData.sceneRole=`ground-atmosphere`;let n=new Ha(20,10),r=[Kf(.11,2503240)];e||r.push(Kf(.065,3686743)),r.forEach((e,r)=>{let i=new Z(n,e);i.name=`ground-mist-layer-${r+1}`,i.userData.sceneRole=`ground-mist-layer`,i.rotation.x=-Math.PI/2,i.rotation.z=r*.24,i.position.set(r===0?0:.7,Bu+.09+r*.09,-7),i.renderOrder=2+r,t.add(i)});let i=Kf(e?.11:.145,5464696);r.push(i);let a=e?[[3.8,Bu+.38,-5.15,-.04]]:[[-4.35,Bu+.36,-5,.025],[.1,Bu+.43,-5.35,-.015],[4.15,Bu+.37,-5.1,-.035]],o=new oi(new Ha(5.2,.72),i,a.length);o.name=`fog-banks`,o.userData.sceneRole=`fog-banks`,o.renderOrder=4;let s=new J,c=new G,l=new Ot,u=new G(1,1,1),d=new on;if(a.forEach(([e,t,n,r],i)=>{c.set(e,t,n),l.setFromEuler(d.set(0,0,r)),s.compose(c,l,u),o.setMatrixAt(i,s)}),o.instanceMatrix.needsUpdate=!0,o.computeBoundingBox(),o.computeBoundingSphere(),t.add(o),!e){let e=new to({vertexShader:Wf,fragmentShader:Gf,uniforms:Qa.merge([$.fog,{uColour:{value:new Y(7374250)},uOpacity:{value:.055}}]),transparent:!0,depthWrite:!1,blending:2,side:2,fog:!0}),n=new Ha(2.2,5.4);for(let[r,i]of[1.3,3.15].entries()){let a=new Z(n,e);a.name=`moonlight-shaft-${r+1}`,a.userData.sceneRole=`moonlight-shaft`,a.position.set(i,1.15,-6.85-r*.4),a.rotation.set(0,-.08,-.2),t.add(a)}}function f(e,t){for(let t=0;t<r.length;t++)r[t].uniforms.uTime.value=e*(t===0?1:-.73)+t*17}return{group:t,update:f}}var Jf=new G(0,1,0),Yf=new Si(.62,1,1,7,1,!1);function Xf(e){let t=Math.sin(e*12.9898+78.233)*43758.5453;return t-Math.floor(t)}function Zf(e,t,n,r,i,a,o){let s=t.clone().addScaledVector(n,r);if(e.push({start:t,end:s,radius:i}),a!==0)for(let t of[-1,1]){let c=o*2+(t>0?7:3),l=.32+Xf(c)*.25,u=new G(n.x*.62+t*l,n.y*.65+.12+Xf(c+1)*.08,n.z*.55+(Xf(c+2)-.5)*.52).normalize();Zf(e,s.clone(),u,r*(.68+Xf(c+3)*.06),i*.66,a-1,c)}}function Qf(e,t,n,r,i){let a=new G(t,Bu,n),o=new G(t+r,Bu+2.15,n-.08);e.push({start:a,end:o,radius:.115});let s=t<0?.42:-.42;Zf(e,o.clone(),new G(s,.72,-.08).normalize(),.92,.075,4,i),Zf(e,o.clone().add(new G(0,-.18,0)),new G(-s*.78,.7,.15).normalize(),.82,.07,3,i+41)}function $f(e=!1){let t=new wn;t.name=`bare-trees`,t.userData.sceneRole=`bare-trees`;let n=[];Qf(n,-4.65,-5.9,.24,17),Qf(n,4.55,-6.6,-.18,83);let r=new oi(Yf,new ro({color:1576981,roughness:1}),n.length);r.name=`bare-tree-branches`,r.userData.sceneRole=`bare-tree-branches`;let i=new G,a=new G,o=new Ot,s=new G,c=new J;return n.forEach((e,t)=>{a.subVectors(e.end,e.start);let n=a.length();a.multiplyScalar(1/n),i.copy(e.start).add(e.end).multiplyScalar(.5),o.setFromUnitVectors(Jf,a),s.set(e.radius,n,e.radius),c.compose(i,o,s),r.setMatrixAt(t,c)}),r.instanceMatrix.needsUpdate=!0,r.computeBoundingBox(),r.computeBoundingSphere(),t.add(r,xd([{position:[-4.48,Bu+.024,-5.68],rotation:[-Math.PI/2,0,0],scale:[.72,1.55]},{position:[4.42,Bu+.024,-6.38],rotation:[-Math.PI/2,0,0],scale:[.68,1.42]}],`tree-root-contact-occlusion`)),t}var ep=[{x:-6.2,z:-10.8,yaw:.1,width:3,height:3.25,depth:2,wall:3617065,roof:1512216,porch:!1},{x:-3.25,z:-8.8,yaw:.04,width:2.75,height:3.1,depth:1.9,wall:2700346,roof:1120029,porch:!0},{x:0,z:-10.2,yaw:-.02,width:3.2,height:3.5,depth:2.1,wall:3484728,roof:1512221,porch:!0},{x:3.45,z:-9,yaw:-.06,width:2.65,height:2.9,depth:1.9,wall:3812648,roof:1971477,porch:!0},{x:6.3,z:-11.2,yaw:-.12,width:3.1,height:3.3,depth:2,wall:2699319,roof:1185051,porch:!1}],tp=new bi(1,1,1),np=new Si(.045,.055,1,7),rp=new ea;rp.moveTo(-.5,0),rp.lineTo(.5,0),rp.lineTo(0,.62),rp.closePath();var ip=new Ra(rp,{depth:1,bevelEnabled:!1});ip.translate(0,0,-.5);function ap(){let e=[],t=[];function n(n,r,i,a,o,s){let c=new Y(s);e.push(n,r,o,i,r,o,i,a,o,n,r,o,i,a,o,n,a,o);for(let e=0;e<6;e++)t.push(c.r,c.g,c.b)}n(-.28,-.36,.28,.36,0,1512728),n(-.22,-.3,.22,.3,.002,16756826),n(-.22,-.3,-.11,.3,.004,5579033),n(.11,-.3,.22,.3,.004,5579033),n(-.022,-.3,.022,.3,.006,2365977),n(-.22,-.018,.22,.018,.006,2365977);let r=new Er;return r.setAttribute(`position`,new X(e,3)),r.setAttribute(`color`,new X(t,3)),r.computeBoundingSphere(),r}var op=ap();function sp(e,t,n,r){let i=new wn;i.userData.sceneRole=`lit-window`,i.position.set(t,n,r);let a=new Z(op,e);return a.userData.sceneRole=`curtain`,i.add(a),i}function cp(e,t,n,r){let i=new wn;i.name=`neighbourhood-house-${t+1}`,i.userData.sceneRole=`house`,i.position.set(e.x,Bu,e.z),i.rotation.y=e.yaw;let a=Bd(new ro({color:e.wall,emissive:e.wall,emissiveIntensity:r?.14:.075,roughness:.94}),t%2==0?`plaster`:`siding`,r),o=Bd(new ro({color:e.roof,emissive:e.roof,emissiveIntensity:r?.045:.02,roughness:.98}),`shingles`,r),s=Bd(new ro({color:5259835,roughness:.9}),`wood`,r),c=Bd(new ro({color:2168084,roughness:.82}),`wood`,r),l=new Lr({color:16777215,vertexColors:!0}),u=new Z(tp,a);u.userData.sceneRole=`house-wall`,u.scale.set(e.width,e.height,e.depth),u.position.y=e.height/2;let d=new Z(ip,o);d.userData.sceneRole=`house-roof`,d.scale.set(e.width+.35,1.35,e.depth+.35),d.position.y=e.height;let f=new Z(tp,s);f.scale.set(e.width+.08,.18,e.depth+.08),f.position.y=.09;let p=new Z(tp,c);p.scale.set(.58,1.15,.07),p.position.set(0,.665,e.depth/2+.045),i.add(u,d,f,p);let m=[{position:[0,.024,e.depth/2+.22],rotation:[-Math.PI/2,0,0],scale:[e.width*.92,.56]}];r||(m.push({position:[0,e.height-.1,e.depth/2+.006],scale:[e.width*.9,.18]}),e.porch&&m.push({position:[0,1.28,e.depth/2+.007],scale:[1.46,.24]})),i.add(xd(m,`house-${t+1}-contact-occlusion`));let h=e.depth/2+.055,g=e.width*.27,_=e.height*.68,v=e.height*.3;if(i.add(sp(l,-g,_,h),sp(l,g,_,h),sp(l,t%2==0?-g:g,v,h)),t===1||t===3){let e=new Go(16748346,2.1,4.2,2);e.name=`window-glow-${t}`,e.userData.sceneRole=`window-glow-light`,e.position.set(0,1.2,h+.48),i.add(e)}if(e.porch){let t=new Z(tp,s);t.scale.set(1.5,.09,.72),t.position.set(0,1.42,e.depth/2+.34),i.add(t);for(let t of[-.62,.62]){let n=new Z(np,s);n.scale.y=1.28,n.position.set(t,.72,e.depth/2+.61),i.add(n)}}if(t%2==0){let t=new Z(tp,a);t.scale.set(.28,.82,.3),t.position.set(e.width*.28,e.height+.48,.15),i.add(t)}return n.push({material:l,phase:t*1.37,frequency:2.1+t*.31}),i}function lp(e=!1){let t=new wn;t.name=`neighbourhood`,t.userData.sceneRole=`neighbourhood`;let n=[];ep.forEach((r,i)=>t.add(cp(r,i,n,e))),t.add($f(e));function r(e){for(let t of n){let n=Math.sin(e*t.frequency+t.phase),r=Math.sin(e*7.3+t.phase*2.4),i=.86+n*.08+r*.035;t.material.color.setRGB(i,i*.93,i*.82)}}return{group:t,update:r}}var up=[{x:-2.3,z:-1.88,scale:1,yaw:.08,lit:!0},{x:2.35,z:-2.02,scale:.86,yaw:-.12,lit:!0},{x:-3.15,z:-5.55,scale:.78,yaw:.1,lit:!1},{x:3.28,z:-5.62,scale:.72,yaw:-.08,lit:!1}];function dp(){let e=new Ga(.3,24,16),t=e.getAttribute(`position`),n=new G;for(let e=0;e<t.count;e++){n.fromBufferAttribute(t,e);let r=Math.atan2(n.z,n.x),i=1+.065*Math.cos(r*8);t.setXYZ(e,n.x*i,n.y*.8,n.z*i)}return e.computeVertexNormals(),e}function fp(){let e=new ea;e.moveTo(-.14,.04),e.lineTo(-.045,.04),e.lineTo(-.092,.13),e.closePath();let t=new ea;t.moveTo(.045,.04),t.lineTo(.14,.04),t.lineTo(.092,.13),t.closePath();let n=new ea;return n.moveTo(-.15,-.035),n.lineTo(-.1,-.095),n.lineTo(-.05,-.04),n.lineTo(0,-.11),n.lineTo(.05,-.04),n.lineTo(.1,-.095),n.lineTo(.15,-.035),n.lineTo(.12,-.14),n.lineTo(-.12,-.14),n.closePath(),new Ua([e,t,n])}var pp=dp(),mp=fp(),hp=new Si(.035,.05,.14,7),gp=new ro({color:14179346,roughness:.7,emissive:7282952,emissiveIntensity:.32}),_p=new ro({color:3883549,roughness:1}),vp=new Lr({color:16757051});function yp(e,t){let n=new wn;n.name=`carved-pumpkin-${t+1}`,n.userData.sceneRole=`carved-pumpkin`,n.position.set(e.x,Bu,e.z),n.rotation.y=e.yaw,n.scale.setScalar(e.scale);let r=new Z(pp,gp);r.position.y=.24;let i=new Z(mp,vp);i.name=`candlelit-carving`,i.position.set(0,.25,.302);let a=new Z(hp,_p);if(a.position.y=.53,a.rotation.z=t%2==0?.11:-.08,n.add(r,i,a),!e.lit)return{group:n};let o=new Go(16745512,1.35,2.7,2);return o.position.set(0,.25,.38),n.add(o),{group:n,light:o}}function bp(e=!1){let t=new wn;t.name=`street-pumpkins`,t.userData.sceneRole=`pumpkins`;let n=[];up.forEach((e,r)=>{let i=yp(e,r);t.add(i.group),i.light&&n.push({light:i.light,phase:r*1.73})});let r=e?up.filter(e=>e.lit):up;t.add(xd(r.map(e=>({position:[e.x,Bu+.024,e.z],rotation:[-Math.PI/2,0,0],scale:[.56*e.scale,.42*e.scale]})),`pumpkin-contact-occlusion`));function i(e){for(let{light:t,phase:r}of n){let n=Math.sin(e*3.7+r),i=Math.sin(e*11.1+r*2.3);t.intensity=1.35*(.9+n*.07+i*.03)}}return{group:t,update:i}}var xp=``+new URL(`backdrop-CDeIWZQh.jpg`,import.meta.url).href;function Sp(e,t=40){let n=new Lr({fog:!1,depthWrite:!1,depthTest:!1}),r=new Z(new Ha(1,1),n);r.renderOrder=-1,r.frustumCulled=!1;let i=new G;e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,t),r.quaternion.copy(e.quaternion);let a=Dt.degToRad(e.fov),o=2*t*Math.tan(a/2),s={mesh:r,ready:Promise.resolve(),texture:null};return s.ready=new Promise((e,t)=>{new Do().load(xp,t=>{t.colorSpace=``,t.minFilter=c,t.generateMipmaps=!1;let i=t.image.width/t.image.height,a=o*i;r.geometry.dispose(),r.geometry=new Ha(a,o),n.map=t,n.needsUpdate=!0,s.texture=t,e()},void 0,e=>t(e instanceof Error?e:Error(String(e))))}),s}var Cp=.11,wp=-.03,Tp=.72,Ep={wander:.25,damping:.8,repelDist:Cp*2.4,repelStrength:.6,wallRadius:Tp,wallStrength:3,maxSpeed:.12};function Dp(e,t=wp){return e+t}function Op(e,t,n,r){return e+(t-e)*(1-Math.exp(-n*r))}function kp(e,t,n,r){let i=0,a=0;for(let o of t){let t=e.x-o.x,s=e.z-o.z,c=Math.hypot(t,s);if(c===0||c>=n)continue;let l=r*(1-c/n);i+=t/c*l,a+=s/c*l}return{x:i,z:a}}function Ap(e,t,n){let r=Math.hypot(e.x,e.z);if(r<=t||r===0)return{x:0,z:0};let i=n*(r-t);return{x:-e.x/r*i,z:-e.z/r*i}}function jp(e,t,n,r,i=Ep){let a=(r()*2-1)*i.wander,o=(r()*2-1)*i.wander,s=kp(e,t,i.repelDist,i.repelStrength),c=Ap(e,i.wallRadius,i.wallStrength);a+=s.x+c.x,o+=s.z+c.z;let l=Math.exp(-i.damping*n),u=(e.vx+a*n)*l,d=(e.vz+o*n)*l,f=Math.hypot(u,d);return f>i.maxSpeed&&(u*=i.maxSpeed/f,d*=i.maxSpeed/f),{...e,x:e.x+u*n,z:e.z+d*n,vx:u,vz:d}}function Mp(e,t,n=.9){let r=Math.sqrt(Math.max(0,1-e*e-t*t));return{rx:Math.atan2(t,r)*n+0,rz:-Math.atan2(e,r)*n+0}}function Np(e,t,n=Tp,r=Cp*2.2,i=50){let a={x:0,z:0},o=-1/0;for(let s=0;s<i;s++){let i=Math.sqrt(t())*n,s=t()*Math.PI*2,c={x:Math.cos(s)*i,z:Math.sin(s)*i},l=1/0;for(let t of e)l=Math.min(l,Math.hypot(c.x-t.x,c.z-t.z));if(l>=r)return c;l>o&&(o=l,a=c)}return a}var Pp=[12986408,13840175,12000284,15022389,10275941,12986408,14172949];function Fp(e){let t=new wn,n=new Z(new Ga(Cp,32,24),new ro({color:e,roughness:.35,metalness:0,emissive:e,emissiveIntensity:.12}));n.scale.set(1,.88,1);let r=new Z(new Si(.008,.012,.06,8),new ro({color:5125166,roughness:.9}));r.position.set(0,Cp*.88+.02,0),r.rotation.z=.25;let i=new Z(new Ga(.03,12,8),new ro({color:4431943,roughness:.7}));return i.scale.set(1,.25,.5),i.position.set(.035,Cp*.88+.03,0),t.add(n,r,i),t}var Ip=class{id;group;state;caught=!1;constructor(e,t,n){this.id=e,this.group=Fp(n),this.group.rotation.order=`ZXY`,this.group.userData.appleId=e,this.state={x:t.x,z:t.z,vx:0,vz:0,y:wp,spin:Math.random()*Math.PI*2},this.group.position.set(t.x,this.state.y,t.z)}moveTo(e){this.state={...this.state,x:e.x,z:e.z,vx:0,vz:0,y:wp},this.group.position.set(e.x,this.state.y,e.z)}};function Lp(e,t){let n=[];for(let r=0;r<e;r++){let e=Np(n.map(e=>e.state),t);n.push(new Ip(r,e,Pp[r%Pp.length]))}return n}function Rp(e,t){let n=t;for(;n;){let t=n.userData.appleId;if(typeof t==`number`)return e[t]??null;n=n.parent}return null}function zp(e,t,n,r){let i=e.filter(e=>!e.caught);for(let e of i){let a=i.filter(t=>t!==e).map(e=>e.state),o=jp(e.state,a,n,r),s=t(o.x,o.z);o={...o,y:Op(o.y,Dp(s.height),10,n),spin:o.spin+.25*n},e.state=o;let c=Mp(s.nx,s.nz);e.group.position.set(o.x,o.y,o.z),e.group.rotation.set(c.rx,o.spin,c.rz)}}var Bp=class{scene=new Nn;camera=new Ko(-1,1,1,-1,0,1);mesh;constructor(e){this.mesh=new Z(new Ha(2,2),e),this.mesh.frustumCulled=!1,this.scene.add(this.mesh)}render(e,t){e.setRenderTarget(t),e.render(this.scene,this.camera)}},Vp=`const float IOR_AIR = 1.0;
...
`,Up=Hp;function Wp(e,t){return`${Hp}${t===`fragment`?`#define BUCKET_FRAGMENT
`:``}${Vp}\n${e}`}var Gp=`in vec3 position;
out vec2 coord;
...
`,Kp=`const float PI = 3.141592653589793;
...
`;function Yp(e){return new qt(256,256,{type:e,format:E,minFilter:c,magFilter:c,wrapS:r,wrapT:r,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1})}function Xp(e,t){return new no({glslVersion:Ue,vertexShader:Up+Gp,fragmentShader:Up+e,uniforms:t,depthTest:!1,depthWrite:!1})}var Zp=class{a;b;current;dropMat;updateMat;normalsMat;pass;queue=[];constructor(e){let t=e?_:v;this.a=Yp(t),this.b=Yp(t),this.current=this.a;let n=new W(1/256,1/256);this.dropMat=Xp(Kp,{uWater:{value:null},uCenter:{value:new W},uRadius:{value:.03},uStrength:{value:.04}}),this.updateMat=Xp(qp,{uWater:{value:null},uDelta:{value:n}}),this.normalsMat=Xp(Jp,{uWater:{value:null},uDelta:{value:n}}),this.pass=new Bp(this.updateMat)}get texture(){return this.current.texture}addDrop(e,t,n=.03,r=.04){this.queue.push({x:e,z:t,radius:n,strength:r})}step(e){for(let t of this.queue)this.dropMat.uniforms.uCenter.value.set(t.x,t.z),this.dropMat.uniforms.uRadius.value=t.radius,this.dropMat.uniforms.uStrength.value=t.strength,this.swapRender(e,this.dropMat);this.queue=[],this.swapRender(e,this.updateMat),this.swapRender(e,this.normalsMat)}swapRender(e,t){t.uniforms.uWater.value=this.current.texture;let n=this.current===this.a?this.b:this.a;this.pass.mesh.material=t,this.pass.render(e,n),this.current=n}},Qp=`in vec3 position;
out vec3 oldPos;
out vec3 newPos;
...
`,em=1024,tm=class{target=new qt(em,em,{type:d,format:E,minFilter:c,magFilter:c,depthBuffer:!1,stencilBuffer:!1});scene=new Nn;camera=new Ko(-1,1,1,-1,0,1);material;clearColor=new Y;constructor(e,t){this.material=new no({glslVersion:Ue,vertexShader:Wp(Qp,`vertex`),fragmentShader:Up+$p,uniforms:{uLight:{value:Vu},uWater:{value:null},uCaustics:{value:null},uIron:{value:t}},depthTest:!1,depthWrite:!1});let n=new Z(e,this.material);n.frustumCulled=!1,this.scene.add(n)}get texture(){return this.target.texture}update(e,t){this.material.uniforms.uWater.value=t,e.getClearColor(this.clearColor);let n=e.getClearAlpha();e.setRenderTarget(this.target),e.setClearColor(0,0),e.clear(),e.render(this.scene,this.camera),e.setClearColor(this.clearColor,n)}static neutralTexture(){let e=new Zr(new Uint8Array([51,255,0,255]),1,1,E,d);return e.needsUpdate=!0,e}},nm=`
uniform mat4 projectionMatrix;
uniform mat4 modelViewMatrix;
uniform sampler2D uWater;
in vec3 position;
...
`;function im(){return new Ha(2,2,200,200)}var am=class{mesh;material;constructor(e=im(),t){this.material=new no({glslVersion:Ue,vertexShader:Up+nm,fragmentShader:Wp(rm,`fragment`),uniforms:{uLight:{value:Vu},uWater:{value:null},uCaustics:{value:null},uIron:{value:t},uMoonDir:{value:Hu}},side:2}),this.mesh=new Z(e,this.material),this.mesh.frustumCulled=!1}setTextures(e,t){this.material.uniforms.uWater.value=e,this.material.uniforms.uCaustics.value=t}},om=`
uniform mat4 projectionMatrix;
uniform mat4 modelViewMatrix;
uniform mat4 modelMatrix;
in vec3 position;
...
`,cm=class{group=new wn;wallMaterial;floorMaterial;constructor(e){let t={uLight:{value:Vu},uWater:{value:null},uCaustics:{value:null},uIron:{value:e}},n=e=>new no({glslVersion:Ue,vertexShader:Up+om,fragmentShader:Wp(sm,`fragment`),uniforms:t,side:e});this.wallMaterial=n(1),this.floorMaterial=n(0);let r=new Z(new Si(1,1,Ru+zu,96,1,!0),this.wallMaterial);r.position.y=(zu-Ru)/2;let i=new Z(new xi(1,96),this.floorMaterial);i.rotation.x=-Math.PI/2,i.position.y=-Ru,this.group.add(r,i)}setTextures(e,t){this.wallMaterial.uniforms.uWater.value=e,this.wallMaterial.uniforms.uCaustics.value=t}},lm=`
uniform sampler2D uWater;
in vec2 coord;
out vec4 fragColor;
...
`;function um(e,t){let n=t*4;return{height:(e[n]/255-.5)/2,nx:e[n+1]/255*2-1,nz:e[n+2]/255*2-1}}function dm(e,t,n){return e+(t-e)*n}function fm(e,t,n){return{height:dm(e.height,t.height,n),nx:dm(e.nx,t.nx,n),nz:dm(e.nz,t.nz,n)}}function pm(e,t,n,r){let i=n*.5+.5,a=r*.5+.5,o=Math.min(Math.max(i*t-.5,0),t-1),s=Math.min(Math.max(a*t-.5,0),t-1),c=Math.floor(o),l=Math.floor(s),u=Math.min(c+1,t-1),d=Math.min(l+1,t-1),f=o-c,p=s-l;return fm(fm(um(e,l*t+c),um(e,l*t+u),f),fm(um(e,d*t+c),um(e,d*t+u),f),p)}function mm(e){let t=new Uint8Array(e*e*4);for(let n=0;n<e*e;n++)t[n*4]=128,t[n*4+1]=128,t[n*4+2]=128,t[n*4+3]=255;return t}var hm=class{target=new qt(32,32,{type:d,format:E,minFilter:a,magFilter:a,depthBuffer:!1,stencilBuffer:!1});material=new no({glslVersion:Ue,vertexShader:Up+Gp,fragmentShader:Up+lm,uniforms:{uWater:{value:null}},depthTest:!1,depthWrite:!1});pass=new Bp(this.material);buffer=new Uint8Array(4096);latest=mm(32);pending=!1;update(e,t){this.material.uniforms.uWater.value=t,this.pass.render(e,this.target),!this.pending&&(this.pending=!0,e.readRenderTargetPixelsAsync(this.target,0,0,32,32,this.buffer).then(()=>{this.latest.set(this.buffer)}).catch(e=>{console.warn(`Height readback failed`,e)}).finally(()=>{this.pending=!1}))}sample=(e,t)=>pm(this.latest,32,e,t)},gm=`
...
`,_m=class{material=new no({glslVersion:Ue,vertexShader:Up+Gp,fragmentShader:Up+gm,uniforms:{uTex:{value:null}},depthTest:!1,depthWrite:!1});pass=new Bp(this.material);viewport=new Gt;draw(e,t,n=256){e.getViewport(this.viewport),this.material.uniforms.uTex.value=t,e.setRenderTarget(null),e.setScissorTest(!0),e.setScissor(0,0,n,n),e.setViewport(0,0,n,n),e.render(this.pass.scene,this.pass.camera),e.setScissorTest(!1),e.setViewport(this.viewport)}},vm=new ui(new G(0,1,0),0);function ym(e,t){let n=e.getBoundingClientRect();return new W((t.clientX-n.left)/n.width*2-1,-((t.clientY-n.top)/n.height)*2+1)}function bm(e,t){let n=null,r=r=>{if(r.pointerType===`mouse`&&r.button!==0)return;let i=ym(e,r);if(t.onDown(i)&&n===null){try{e.setPointerCapture(r.pointerId)}catch{n=null;return}n=r.pointerId}},i=r=>{r.pointerId===n&&t.onDrag(ym(e,r))},a=r=>{r.pointerId===n&&(e.hasPointerCapture(r.pointerId)&&e.releasePointerCapture(r.pointerId),n=null,t.onUp())},o=e=>{e.pointerId===n&&(n=null,t.onUp())};return e.addEventListener(`pointerdown`,r),e.addEventListener(`pointermove`,i),e.addEventListener(`pointerup`,a),e.addEventListener(`pointercancel`,a),e.addEventListener(`lostpointercapture`,o),()=>{e.removeEventListener(`pointerdown`,r),e.removeEventListener(`pointermove`,i),e.removeEventListener(`pointerup`,a),e.removeEventListener(`pointercancel`,a),e.removeEventListener(`lostpointercapture`,o)}}function xm(e){let t=e.ray.intersectPlane(vm,new G);return!t||Math.hypot(t.x,t.z)>1?null:t}function Sm(e,t){let n=e.slice();for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}var Cm=class{facts;rng;pile=[];constructor(e,t=Math.random){if(this.facts=e,this.rng=t,e.length===0)throw Error(`FactDeck needs at least one fact`)}draw(){return this.pile.length===0&&(this.pile=Sm(this.facts,this.rng)),this.pile.pop()}putBack(e){let t=Math.floor(this.rng()*(this.pile.length+1));this.pile.splice(t,0,e)}get size(){return this.facts.length}remaining(){return this.pile.length}},wm=[{id:`flash-01`,category:`FlashSystem`,title:`One family, one software stack`,body:`PLACEHOLDER: Every IBM FlashSystem model runs the same Storage Virtualize software, so skills and automation carry across the whole range.`},{id:`flash-02`,category:`FlashSystem`,title:`FlashCore Modules compress inline`,body:`PLACEHOLDER: FlashCore Modules compress and encrypt data in hardware, so capacity savings don't cost host performance.`},{id:`flash-03`,category:`FlashSystem`,title:`Ransomware detection on the array`,body:`PLACEHOLDER: FlashSystem can spot ransomware-style write patterns in under a minute using inline data statistics.`},{id:`scale-01`,category:`Storage Scale`,title:`Global data platform`,body:`PLACEHOLDER: IBM Storage Scale presents file, object and HDFS access to the same data, on premises or in the cloud.`},{id:`scale-02`,category:`Storage Scale`,title:`Built for AI pipelines`,body:`PLACEHOLDER: Storage Scale System 6000 is designed to feed GPUs with hundreds of gigabytes per second per node.`},{id:`defender-01`,category:`Storage Defender`,title:`Copies you can trust`,body:`PLACEHOLDER: IBM Storage Defender validates backup copies and safeguarded snapshots so you know which point in time is clean.`},{id:`defender-02`,category:`Storage Defender`,title:`Safeguarded Copy`,body:`PLACEHOLDER: Safeguarded Copy takes immutable, logically air-gapped snapshots that admins cannot delete before their expiry.`},{id:`ceph-01`,category:`Ceph`,title:`Software-defined and open`,body:`PLACEHOLDER: IBM Storage Ceph provides block, file and S3 object storage on commodity servers with an open-source core.`},{id:`ceph-02`,category:`Ceph`,title:`Scale out, not up`,body:`PLACEHOLDER: Add nodes to grow Ceph capacity and performance together, with data rebalanced automatically.`},{id:`tape-01`,category:`Tape`,title:`Tape is still the cheapest bit`,body:`PLACEHOLDER: LTO tape stores cold data at a fraction of the cost per terabyte of disk, with a 30-year archival life.`},{id:`tape-02`,category:`Tape`,title:`Physical air gap`,body:`PLACEHOLDER: A tape cartridge on a shelf cannot be reached by an attacker on the network. That's the original air gap.`},{id:`tip-01`,category:`Tip`,title:`Try tapping the water`,body:`PLACEHOLDER: Tap the open water to make a splash and watch the apples bob.`}],Tm=[`FlashSystem`,`Storage Scale`,`Storage Defender`,`Ceph`,`Tape`,`Tip`],Em=[{id:`fallback-01`,category:`Tip`,title:`Facts are loading`,body:`The fact list could not be read, but the apples still float. Try another one!`}];function Dm(e){if(typeof e!=`object`||!e)return!1;let t=e;return[`id`,`title`,`body`,`category`].every(e=>typeof t[e]==`string`&&t[e].length>0)}function Om(e){return Array.isArray(e)?e.filter(Dm):[]}function km(){let e=Om(wm);return e.length>0?e:Em}var Am=[{id:`q-flash-01`,factId:`flash-01`,prompt:`PLACEHOLDER: Which software runs on every IBM FlashSystem model?`,answers:[`Storage Virtualize`,`Storage Scale`,`Storage Defender`,`Storage Ceph`],correct:0},{id:`q-flash-02`,factId:`flash-02`,prompt:`PLACEHOLDER: Where do FlashCore Modules compress and encrypt data?`,answers:[`In the host operating system`,`In hardware on the module`,`In a backup appliance`,`In the cloud`],correct:1},{id:`q-flash-03`,factId:`flash-03`,prompt:`PLACEHOLDER: Roughly how fast can FlashSystem flag ransomware-style write patterns?`,answers:[`Within a day`,`Within an hour`,`Under a minute`,`Only after a restore`],correct:2},{id:`q-scale-01`,factId:`scale-01`,prompt:`PLACEHOLDER: IBM Storage Scale presents the same data through which access methods?`,answers:[`File only`,`Block and tape`,`File, object and HDFS`,`Email and FTP`],correct:2},{id:`q-scale-02`,factId:`scale-02`,prompt:`PLACEHOLDER: What is Storage Scale System 6000 designed to keep fed?`,answers:[`GPUs`,`Printers`,`Mainframe tape drives`,`Web caches`],correct:0},{id:`q-defender-01`,factId:`defender-01`,prompt:`PLACEHOLDER: What does IBM Storage Defender check about your backup copies?`,answers:[`That they are the largest`,`That they are the oldest`,`That they are clean and trustworthy`,`That they are stored on tape`],correct:2},{id:`q-defender-02`,factId:`defender-02`,prompt:`PLACEHOLDER: What can an admin NOT do to a Safeguarded Copy before it expires?`,answers:[`Read it`,`Delete it`,`Restore from it`,`Report on it`],correct:1},{id:`q-ceph-01`,factId:`ceph-01`,prompt:`PLACEHOLDER: IBM Storage Ceph runs on what kind of hardware?`,answers:[`Proprietary appliances only`,`Commodity servers`,`Mainframes only`,`Tape libraries`],correct:1},{id:`q-ceph-02`,factId:`ceph-02`,prompt:`PLACEHOLDER: How do you grow capacity and performance in a Ceph cluster?`,answers:[`Buy a bigger controller`,`Add nodes`,`Add more tape`,`Reformat the volumes`],correct:1},{id:`q-tape-01`,factId:`tape-01`,prompt:`PLACEHOLDER: What archival life is quoted for LTO tape?`,answers:[`3 years`,`10 years`,`30 years`,`100 years`],correct:2},{id:`q-tape-02`,factId:`tape-02`,prompt:`PLACEHOLDER: Why can't a network attacker reach a tape cartridge on a shelf?`,answers:[`It is encrypted`,`It is physically air-gapped`,`It is compressed`,`It is read-only`],correct:1},{id:`q-tip-01`,factId:`tip-01`,prompt:`PLACEHOLDER: What happens when you tap the open water?`,answers:[`An apple sinks`,`The lights go out`,`You make a splash`,`The cauldron empties`],correct:2}];function jm(e){return typeof e==`string`&&e.length>0}function Mm(e){if(typeof e!=`object`||!e)return!1;let t=e;if(![`id`,`factId`,`prompt`].every(e=>jm(t[e])))return!1;let n=t.answers;if(!Array.isArray(n)||n.length!==4||!n.every(jm))return!1;let r=t.correct;return Number.isInteger(r)&&r>=0&&r<4}function Nm(e){return Array.isArray(e)?e.filter(Mm):[]}function Pm(){return Nm(Am)}function Fm(e){let t=Tm.filter(t=>t!==e.category).slice(0,3);return{id:`fallback-${e.id}`,factId:e.id,prompt:`Which IBM Storage product is this fact about?`,answers:[e.category,...t],correct:0}}function Im(e,t){return e.find(e=>e.factId===t.id)??Fm(t)}function Lm(e,t){let n=Sm(e.answers.map((e,t)=>t),t);return{answers:n.map(t=>e.answers[t]),correct:n.indexOf(e.correct)}}function Rm(e){return{total:e,remaining:e}}function zm(e,t){if(e.remaining<=0)return{state:e,expired:!1};let n=Math.max(0,e.remaining-t);return{state:{total:e.total,remaining:n},expired:n===0}}function Bm(e){return e.total>0?e.remaining/e.total:0}var Vm=.25,Hm=.4,Um=.35;function Wm(){return{phase:`idle`,appleId:null,elapsed:0}}function Gm(e,t){return e.phase===`idle`?{phase:`dunking`,appleId:t,elapsed:0}:e}function Km(e,t){return e.phase===`quizzing`?{phase:t?`lifting`:`releasing`,appleId:e.appleId,elapsed:0}:e}function qm(e){return e.phase===`showing`?{phase:`respawning`,appleId:e.appleId,elapsed:0}:e}function Jm(e){return e.phase===`dunking`?Math.min(1,e.elapsed/Vm):0}function Ym(e){return e.phase===`lifting`?Math.min(1,e.elapsed/Hm):0}function Xm(e){return e.phase===`releasing`?Math.min(1,e.elapsed/Um):0}function Zm(e,t){let n=[];if(e.phase===`idle`||e.phase===`showing`||e.phase===`quizzing`)return{state:e,events:n};let r=e.elapsed+t;return e.phase===`dunking`?r<.25?{state:{...e,elapsed:r},events:n}:(n.push({type:`quizStart`,appleId:e.appleId}),{state:{phase:`quizzing`,appleId:e.appleId,elapsed:0},events:n}):e.phase===`lifting`?(e.elapsed===0&&n.push({type:`liftStart`,appleId:e.appleId}),r<.4?{state:{...e,elapsed:r},events:n}:(n.push({type:`showFact`,appleId:e.appleId}),{state:{phase:`showing`,appleId:e.appleId,elapsed:0},events:n})):e.phase===`releasing`?r<.35?{state:{...e,elapsed:r},events:n}:(n.push({type:`released`,appleId:e.appleId}),{state:Wm(),events:n}):r<.3?{state:{...e,elapsed:r},events:n}:(n.push({type:`respawned`,appleId:e.appleId}),{state:Wm(),events:n})}var Qm=class{minDist;constructor(e=.03){this.minDist=e}last=null;next(e,t){return this.last&&Math.hypot(e-this.last.x,t-this.last.z)<this.minDist?!1:(this.last={x:e,z:t},!0)}reset(){this.last=null}};function $m(e){let t=document.getElementById(e);if(!t)throw Error(`Missing #${e}`);return t}var eh=class{onDismiss;card=$m(`fact-card`);backdrop=$m(`backdrop`);category=$m(`fact-category`);progress=$m(`fact-progress`);title=$m(`fact-title`);body=$m(`fact-body`);button=$m(`fact-dismiss`);open=!1;constructor(e){this.onDismiss=e,this.button.addEventListener(`click`,()=>this.hide()),this.backdrop.addEventListener(`pointerdown`,()=>this.hide())}get isOpen(){return this.open}show(e,t,n){this.category.textContent=e.category,this.progress.textContent=`Fact ${t} of ${n}`,this.title.textContent=e.title,this.body.textContent=e.body,this.card.classList.remove(`hidden`),this.backdrop.classList.remove(`hidden`),this.open=!0,this.button.focus()}hide(){this.open&&(this.card.classList.add(`hidden`),this.backdrop.classList.add(`hidden`),this.open=!1,this.onDismiss())}},th=1100,nh=3,rh=class{card=$m(`quiz-card`);backdrop=$m(`backdrop`);bar=$m(`quiz-bar`);seconds=$m(`quiz-seconds`);category=$m(`quiz-category`);prompt=$m(`quiz-prompt`);buttons=Array.from($m(`quiz-answers`).querySelectorAll(`button.answer`));open=!1;locked=!1;onAnswer=null;constructor(){this.buttons.forEach((e,t)=>{e.addEventListener(`click`,()=>{this.open&&!this.locked&&this.onAnswer?.(t)})})}get isOpen(){return this.open}show(e){this.category.textContent=e.category,this.prompt.textContent=e.prompt,this.buttons.forEach((t,n)=>{t.textContent=e.answers[n]??``,t.disabled=!1,t.classList.remove(`right`,`wrong`)}),this.bar.classList.remove(`urgent`),this.onAnswer=e.onAnswer,this.locked=!1,this.card.classList.remove(`hidden`),this.backdrop.classList.remove(`hidden`),this.open=!0,this.buttons[0]?.focus()}setCountdown(e,t){this.bar.style.width=`${Math.max(0,Math.min(1,e))*100}%`,this.bar.classList.toggle(`urgent`,t<=nh),this.seconds.textContent=String(Math.ceil(t))}resolve(e,t){this.locked=!0;for(let e of this.buttons)e.disabled=!0;let n=e===t;return!n&&e!==null&&this.buttons[e]?.classList.add(`wrong`),this.buttons[t]?.classList.add(`right`),new Promise(e=>window.setTimeout(e,n?500:th))}hide(){this.open&&(this.card.classList.add(`hidden`),this.backdrop.classList.add(`hidden`),this.open=!1,this.onAnswer=null)}},ih=class{counter=$m(`counter`);count=$m(`caught-count`);factsLeft=$m(`facts-left`);attract=$m(`attract`);fps=$m(`fps`);caught=0;fpsEnabled=!1;fpsAccum=0;fpsFrames=0;constructor(){this.counter.addEventListener(`animationend`,()=>this.counter.classList.remove(`pop`))}increment(){this.caught+=1,this.count.textContent=String(this.caught),this.counter.classList.remove(`pop`),this.counter.offsetWidth,this.counter.classList.add(`pop`)}setFactsLeft(e){this.factsLeft.textContent=String(e)}showHint(){this.attract.classList.remove(`hidden`)}hideHint(){this.attract.classList.add(`hidden`)}enableFps(){this.fpsEnabled=!0,this.fps.classList.remove(`hidden`)}updateFps(e){this.fpsEnabled&&(this.fpsAccum+=e,this.fpsFrames+=1,this.fpsAccum>=.5&&(this.fps.textContent=`${Math.round(this.fpsFrames/this.fpsAccum)} fps`,this.fpsAccum=0,this.fpsFrames=0))}},ah=class{threshold;elapsed=0;idle=!1;constructor(e=60){this.threshold=e}get isIdle(){return this.idle}touch(){this.elapsed=0,this.idle=!1}update(e){return!this.idle&&(this.elapsed+=e,this.elapsed>=this.threshold&&(this.idle=!0,!0))}},oh=7,sh=.16,ch=60,lh=2.5,uh=new URLSearchParams(location.search),dh=uh.has(`orbit`),fh=uh.has(`debug`),ph=uh.get(`quality`)===`low`,mh=uh.get(`scene`)!==`procedural`;function hh(e){let t=$m(`error`);t.textContent=e,t.classList.remove(`hidden`)}function gh(){let e=Lu();if(!e.ok){hh(e.reason??`Unsupported display.`);return}q.enabled=!1;let t=new Iu({antialias:!0});t.outputColorSpace=Re,t.setPixelRatio(Math.min(window.devicePixelRatio,ph?1:2)),t.setSize(window.innerWidth,window.innerHeight),$m(`app`).appendChild(t.domElement),console.info(`apple-bobbing: floatLinear=${e.floatLinear} quality=${ph?`low`:`high`}`);let n=new Nn;n.background=new Y(131849);let r=pd(window.innerWidth/window.innerHeight),i=dh?md(r,t.domElement):null;mh&&(Vu.set(.5,.35,.79).normalize(),Hu.copy(Vu));let a=Rf(),o=xf(a);n.add(...hd(),o),mh&&n.add(gd());let s=null,c=null,l=null;function u(){n.fog=new Mn(922141,.045),s=lp(ph),c=bp(ph);let e=ff(ph),t=af(ph);l=qf(ph);let r=_d(ph);n.add(r,r.target,Vf(),of(),e,t,s.group,c.group,l.group)}if(mh){let e=Sp(r);n.add(e.mesh,Sf()),e.ready.then(()=>{if(!e.texture)return;let t=e.texture.clone();t.mapping=303,t.needsUpdate=!0,Cf(o,t,.55)}).catch(()=>{}),e.ready.catch(t=>{console.warn(`Backdrop plate failed to load; falling back to the procedural background.`,t),n.remove(e.mesh),u()})}else u();let d=im(),f=new Zp(e.floatLinear),p=ph?null:new tm(d,a.map),m=p?p.texture:tm.neutralTexture(),h=new am(d,a.map),g=new cm(a.map);n.add(h.mesh,g.group);let _=new hm,v=Lp(oh,Math.random);for(let e of v)n.add(e.group);let y=new Cm(km()),b=new ih,x=y.size;b.setFactsLeft(x),fh&&b.enableFps();let S=Wm(),C=new G,w=new ah(ch),T=0,E=0,D=new eh(()=>{w.touch(),b.hideHint(),S=qm(S)}),O=Pm(),k=new rh,A=null,j=null,ee=()=>D.isOpen||k.isOpen;function M(){let e=y.draw();b.setFactsLeft(y.remaining());let t=Im(O,e),n=Lm(t,Math.random);j={fact:e,correct:n.correct},A=Rm(12),k.setCountdown(1,12),k.show({category:e.category,prompt:t.prompt,answers:n.answers,onAnswer:N})}function N(e){if(!j||S.phase!==`quizzing`||A===null)return;let{fact:t,correct:n}=j,r=e===n;A=null,w.touch(),k.resolve(e,n).then(()=>{k.hide(),r||(j=null,y.putBack(t),b.setFactsLeft(y.remaining())),S=Km(S,r)})}let P=fh?new _m:null,F=new ms,te=new Qm;bm(t.domElement,{onDown:e=>{if(w.touch(),b.hideHint(),ee())return!1;F.setFromCamera(e,r);let t=v.filter(e=>!e.caught).map(e=>e.group),n=F.intersectObjects(t,!0),i=n.length>0?Rp(v,n[0].object):null;if(i&&S.phase===`idle`)return S=Gm(S,i.id),i.caught=!0,C.copy(i.group.position),f.addDrop(i.state.x,i.state.z,.1,.1),!1;let a=xm(F);return a?(f.addDrop(a.x,a.z,.07,.14),te.reset(),te.next(a.x,a.z),!0):!1},onDrag:e=>{w.touch(),F.setFromCamera(e,r);let t=xm(F);t&&te.next(t.x,t.z)&&f.addDrop(t.x,t.z,.045,.04)},onUp:()=>{te.reset()}});for(let e=0;e<12;e++)f.addDrop(Math.random()*1.6-.8,Math.random()*1.6-.8,.05,e%2?.04:-.04);window.addEventListener(`resize`,()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)});let ne=new $o,re=!0,ie=0;function ae(e){re=!1,hh(e)}t.debug.onShaderError=(e,t,n,r)=>{console.error(`Shader link failed`,e.getProgramInfoLog(t),`
vertex:`,e.getShaderInfoLog(n),`
fragment:`,e.getShaderInfoLog(r)),ae(`Rendering failed to start on this display.`)},t.domElement.addEventListener(`webglcontextlost`,()=>{ae(`The display lost its graphics context. Restarting…`),window.setTimeout(()=>location.reload(),3e3)});function oe(){if(!re)return;requestAnimationFrame(oe),ne.update();let e=ne.getDelta(),a=Math.min(e,.05);ie+=a,f.step(t),p?.update(t,f.texture),_.update(t,f.texture),h.setTextures(f.texture,m),g.setTextures(f.texture,m),s?.update(ie),c?.update(ie),l?.update(ie,a),zp(v,_.sample,a,Math.random);let o=Zm(S,a);if(S=o.state,S.phase===`quizzing`&&A!==null){let e=zm(A,a);A=e.state,k.setCountdown(Bm(A),A.remaining),e.expired&&N(null)}let u=S.phase===`dunking`||S.phase===`quizzing`||S.phase===`lifting`||S.phase===`releasing`;if(S.appleId!==null&&u){let e=v[S.appleId];if(S.phase===`dunking`||S.phase===`quizzing`){let t=S.phase===`quizzing`?1:Jm(S),n=1-(1-t)*(1-t);e.group.position.set(C.x,C.y-sh*n,C.z),e.group.scale.set(1+.1*n,1-.15*n,1+.1*n)}else if(S.phase===`releasing`){let t=Xm(S),n=1-(1-(1-t)*(1-t));e.group.position.set(C.x,C.y-sh*n,C.z),e.group.scale.set(1+.1*n,1-.15*n,1+.1*n)}else{let t=Ym(S),n=1-(1-t)**3,r=C.y-sh+.86*n;e.group.position.set(C.x,r,C.z),e.group.rotation.set(0,e.state.spin+t*2,0),e.group.scale.setScalar(1+.3*t)}}for(let e of o.events){let t=v[e.appleId];if(e.type===`quizStart`)M();else if(e.type===`liftStart`)f.addDrop(t.state.x,t.state.z,.09,-.12);else if(e.type===`showFact`)t.group.visible=!1,b.increment(),j&&D.show(j.fact,x-y.remaining(),x),j=null;else if(e.type===`released`)t.group.position.copy(C),t.group.scale.setScalar(1),t.caught=!1,f.addDrop(t.state.x,t.state.z,.08,.1);else{let e=Np(v.filter(e=>e!==t).map(e=>e.state),Math.random);t.moveTo(e),t.group.scale.setScalar(1),t.group.visible=!0,t.caught=!1,f.addDrop(e.x,e.z,.07,.1)}}if(!ee()&&w.update(e)&&(b.showHint(),T=Math.floor(Math.random()*v.length),E=lh),w.isIdle&&!ee()&&(E+=a,E>=lh)){E=0;let e=v.filter(e=>!e.caught);if(e.length>0){let t=e[T%e.length];f.addDrop(t.state.x,t.state.z,.09,.08)}}i?.update(),t.setRenderTarget(null),t.render(n,r),P?.draw(t,f.texture),b.updateFps(e)}oe()}gh();